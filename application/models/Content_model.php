...
class Content_model extends MY_Model {
    ...
    public function get($id = null, $admin_id = null) {
        ...
        if ($admin_id != null) {
            $this->db->where('contents.admin_id', $admin_id);
        }
    ...
    public function getContentByRole($id = null, $role = null) {
        $inner_sql = "";
        if ($role != "Super Admin") {
            $inner_sql = " WHERE (role='student' and content_for.created_by='" . $id . "' ) or (content_for.created_by=1 and role='" . $role . "')";
        }
    ...
    public function getListByCategory($category, $admin_id=null) {
    ...
    public function search_by_content_type($text, $admin_id = null) {
        ...
        if (isset($data['id'])) {
            ...
            if (isset($content_role) && !empty($content_role)) {
                ...
                for ($i = 0; $i < $total_rec; $i++) {
                    $content_role[$i]['admin_id'] = $data['admin_id'];
                    $content_role[$i]['created_by'] = $data['created_by'];
