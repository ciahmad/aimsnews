...
class Onlineexam_model extends MY_model {
    ...
    public function get($id = null, $publish = null, $admin_id=null) {
        ...
        if($admin_id !=null){
            $this->db->where('onlineexam.admin_id', $admin_id);
        }
        $query = $this->db->get();
        if ($id != null) {
            return $query->row();
    ...
    public function searchOnlineExamStudents($class_id, $section_id, $onlineexam_id, $admin_id=null) {
