...
class Batchsubject_model extends CI_Model {
    ...
    public function getExamSubjects($id = null, $admin_id = null, $userdata) {
       ...
       // $userdata = $this->customlib->getuserdata();
        ...
        //         $my_classes = $this->teacher_model->my_classes(null,$admin_id);
        ...
        //             $my_subjects = $this->teacher_model->get_examsubjects($userdata['admin_id']);
        //         }
        //     }
        // }
       ...
       $this->db->order_by('exam_group_class_batch_exam_subjects.id');
        if($admin_id != null){
            $this->db->where('exam_group_class_batch_exam_subjects.admin_id', $admin_id);
        }
    ...
    public function examGroupExamResult($class_id, $batch_id, $exam_group_class_batch_exams_id, $admin_id = null) {

        $exam_students = $this->attempt_exam_students($class_id, $batch_id, $exam_group_class_batch_exams_id, $admin_id);
