...
class Income_model extends My_Model {
    ...
    public function get($id = null) {
        $this->db->select('income.id,income.date,income.staff_std_id,income.staff_type,income.cash_bank,income.bank_account_id,income.name,income.invoice_no,income.reference_number,income.amount,income.documents,income.note,income_head.income_category,income.inc_head_id')->from('income');
        $this->db->join('income_head', 'income.inc_head_id = income_head.account_id');
        if ($id != null) {
