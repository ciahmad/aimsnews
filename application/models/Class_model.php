...
class Class_model extends MY_Model {
     ...
     * @return mixed
     */
    public function getAll($id = null, $admin_id=null) {
    ...
    public function get($id = null, $classteacher = null, $admin_id = null) {
    ...
    public function check_data_exists($data, $admin_id = null) {
    ...
    public function class_exists($str) {
        ...
        $res = $this->check_data_exists($class, $admin_id);
    ...
    public function getClassTeacher($admin_id) {

        $this->current_session = $this->setting_model->getCurrentSession($admin_id);
        $query = $this->db->query('SELECT class_teacher.*,classes.class,sections.section FROM `class_teacher` INNER JOIN classes on classes.id=class_teacher.class_id INNER JOIN sections on sections.id=class_teacher.section_id where class_teacher.session_id="' . $this->current_session . '" and class_teacher.admin_id="' . $admin_id . '" GROUP BY class_teacher.class_id , class_teacher.section_id ORDER by length(classes.class), classes.class');
