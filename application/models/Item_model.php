...
class Item_model extends MY_Model {
    ...
    public function getItemByCategory($item_category_id, $admin_id = null) {
        ...
        if($admin_id !=null){
            $this->db->where('item.admin_id', $admin_id);
        }
        $query = $this->db->get();
        return $query->result_array();
    }

    public function getItemunit($id, $admin_id = null) {
    ...
    public function get($id = null, $admin_id=null) {
        ...
        if($admin_id !=null){
            $query = $query . " where item.admin_id =" . $admin_id;
        }
    ...
    public function getItemAvailable($item_id = null,$admin_id=null) {
        $where = "";
