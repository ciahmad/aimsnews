...
class Teacher_model extends CI_Model {
    ...
    public function getLibraryTeacher($admin_id =null) {
    ...
    public function my_classes($staff_id,$admin_id=null) {
        //echo 1;die();
        $class_id = array();
        $query = $this->db->query("select ct.class_id  from class_teacher ct  where  ct.staff_id='" . $staff_id . "' and session_id='" . $this->current_session . "' and ct.admin_id='" . $admin_id . "' ");
       // print_r($query); die('query');
    ...
    public function get_classbysubject_group_id($subject_group_id, $admin_id=null) {

        $query = $this->db->query("select st.class_id from subject_timetable st where st.subject_group_id='" . $subject_group_id . "' and session_id='" . $this->current_session . "' and st.admin_id='" . $admin_id . "' group by st.class_id");
