...
class Subjectgroup_model extends MY_Model {
    ...
    public function check_data_exists($name, $admin_id = null) {
        if($admin_id != null){
    ...
    public function class_exists($str) {
        ...
        $res = $this->check_data_exists($name, $admin_id);
    ...
    public function add($data, $subject_group, $section_group) {
        ...
        foreach ($subject_group as $sub_group_key => $sub_group_value) {
            $vehicle_array = array(
                ...
                'subject_group_id' => $subject_group_id,
                'subject_id' => $sub_group_value,
                'session_id' => $this->setting_model->getCurrentSession($data['admin_id']),
            );
    ...
    public function getByID($id = null, $admin_id=null) {
        ...
        if($admin_id !=null){
            $this->db->where('subject_groups.admin_id',$admin_id);
        }
    ...
    public function getGroupsubjects($subject_group_id, $admin_id=null) {
        $class_id = "";
            ...
            if ($userdata["class_teacher"] == 'yes') {
                ...
                if (!empty($my_classes)) {
                   ...
                   // $my_subjects = $this->teacher_model->get_subjectby_staffid($userdata['id']);
                    $my_subjects = $this->teacher_model->get_subjectby_staffid($admin_id);
