...
class Stuattendence_model extends MY_Model {
    ...
    public function searchAttendenceClassSectionPrepare($class_id, $section_id, $date, $admin_id=null) {
        if($admin_id !=null){
            $this->db->where('student_attendences.admin_id', $admin_id);
        }
    ...
    public function getTodayDayAttendance($total_student, $admin_id=null) {
