...
class syllabus_model extends CI_Model {
    ...
    public function get_subject_syllabus($data, $staff_id, $admin_id=null) {
        ...
        if($admin_id !=null){
            $this->db->where('subject_syllabus.admin_id', $admin_id);
        }
    ...
    public function get_subject_syllabusdata($subject_group_subject_id, $date, $role_id, $staff_id, $time_from, $time_to, $subject_group_class_sections_id,$admin_id=null) {
    ...
    public function get_subjectteachersreport($subject_group_subject_id, $subject_group_class_sections_id,$admin_id=null) {
    ...
    public function get_subjectsyllabusbyid($id,$admin_id=null) {
        return $this->db->select('subject_syllabus.*,lesson.name as lesson_name,topic.name as topic_name')->from('subject_syllabus')->join('topic', 'topic.id=subject_syllabus.topic_id')->join('lesson', 'lesson.id=topic.lesson_id')->where('subject_syllabus.id', $id)->where('subject_syllabus.admin_id',$admin_id)->get()->row_array();
    }
