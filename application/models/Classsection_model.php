...
class Classsection_model extends MY_Model {
    ...
    public function getDetailbyClassSection($class_id, $section_id,$admin_id=null) {
        ...
        if ($id != null) {
            ...
            if (!empty($vehicle_routes)) {
                foreach ($vehicle_routes as $vehicle_key => $vehicle_value) {
                    ...
                    $vec_route->vehicles = $this->getVechileByRoute($vehicle_value['id'], $admin_id);
                    $array[] = $vec_route;
                }
            }
            return $array;
    ...
    public function allClassSections($admin_id=null) {

        $classes = $this->class_model->get(null,null,$admin_id);
        if (!empty($classes)) {
