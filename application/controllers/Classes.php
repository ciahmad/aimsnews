...
class Classes extends Admin_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules(
                'class', $this->lang->line('class'), array('required', array('class_exists', array($this->class_model, 'class_exists')))
        );
        ...
        $vehicle_result = $this->section_model->get(null, $this->userdata['admin_id']);
        $data['vehiclelist'] = $vehicle_result;

        $vehroute_result = $this->classsection_model->getByID(null, $this->userdata['admin_id']);
