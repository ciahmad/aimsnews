...
class Homework extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('sub_heading', 'CONTENTS CENTRE');
        ...
        $homeworklist = $this->homework_model->get(null, $this->userdata['admin_id']);
       // echo '<pre>';print_r($homeworklist); die();
        ...
        if ($this->form_validation->run() == false) {
            ...
            $homeworklist = $this->homework_model->search_homework($class_id, $section_id, $subject_group_id, $subject_id, $this->userdata['admin_id']);
          //  print_r($homeworklist); die();

            $data["homeworklist"] = $homeworklist;

            foreach ($data["homeworklist"] as $key => $value) {
                $report = $this->homework_model->getEvaluationReport($value["id"], $this->userdata['admin_id']);
    ...
    public function homework_docs($id) {
        $result = $this->homework_model->get_homeworkDocByid($id, $this->userdata['admin_id']);
    ...
    public function create() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($record_id == 0) {
                $homework_detail = $this->homework_model->get($id, $this->userdata['admin_id']);
    ...
    public function getRecord() {
        ...
        $result = $this->homework_model->get($id, $this->userdata['admin_id']);
        $data["result"] = $result;
    ...
    public function evaluation($id) {
        ...
        $data["created_by"] = "";
        $data["evaluated_by"] = "";
        $result = $this->homework_model->getRecord($id, $this->userdata['admin_id']);
        $class_id = $result["class_id"];
        $section_id = $result["section_id"];
        $studentlist = $this->homework_model->getStudents($id, $this->userdata['admin_id']);
    ...
    public function add_evaluation() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->homework_model->addEvaluation($insert_prev, $insert_array, $homework_id, $evaluation_date, $evaluated_by, $this->userdata['admin_id'], $this->userdata['id']);
    ...
    public function evaluation_report() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['resultlist'] = $this->homework_model->search_homework($class_id, $section_id, $subject_group_id, $subject_id, $this->userdata['admin_id']);
    ...
    public function getreport($id = 1) {
        ...
        if (!empty($result)) {
            ...
            $data["created_by"] = $created_by;
            $data["evaluated_by"] = $evaluated_by;
            $studentlist = $this->homework_model->getStudents($class_id, $section_id,$this->userdata['admin_id']);
            $data["studentlist"] = $studentlist;
    ...
    public function count_percentage($id, $class_id, $section_id) {
        $data = array();
        $count_students = $this->homework_model->count_students($class_id, $section_id, $this->userdata['admin_id']);

        $count_evalstudents = $this->homework_model->count_evalstudents($id, $class_id, $section_id,$this->userdata['admin_id']);
