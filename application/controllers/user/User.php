...
class User extends Student_Controller
{
    ...
    public function choose()
    {
        ...
        $std_admin_id     = $this->customlib->getStudentSessionUserAdminID();
        if ($role == "student") {
            $student_id       = $this->customlib->getStudentSessionUserID();
            $student_lists = $this->studentsession_model->searchMultiClsSectionByStudent($student_id);
            $data['student_lists'] = $student_lists;
        } elseif ($role == "parent") {
            $parent_id             = $this->customlib->getUsersID();
            $student_lists = $this->student_model->getParentChilds($parent_id);
            $data['student_lists'] = $student_lists;
        }
        ...
        if ($this->form_validation->run() == true) {
            ...
            $student        = $this->student_model->getByStudentSession($student_session_id, $std_admin_id);
