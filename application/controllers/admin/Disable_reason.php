...
class Disable_reason extends Admin_Controller {
    ...
    public function index() {
        ...
        $data['results'] = $this->disable_reason_model->get('',$this->userdata['admin_id']);
    ...
    public function edit($id) {
        ...
        $this->session->set_userdata('top_menu', 'Student Information');
        $this->session->set_userdata('sub_menu', 'student/disable_reason');
        $data['data'] = $this->disable_reason_model->get($id,$this->userdata['admin_id']);
        $data['results'] = $this->disable_reason_model->get('',$this->userdata['admin_id']);
    ...
    public function get_details($id) {
        $data = $this->disable_reason_model->get($id, $this->userdata['admin_id']);
