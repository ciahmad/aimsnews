...
class Receiptvoucher extends Admin_Controller {
    ...
    public function index() {
        ...
        $invoice_no = $this->receiptvoucher_model->isInvoiceNoExist();
        ...
        $receiptvoucher_result = $this->receiptvoucher_model->get();
    ...
    public function view($id) {
        ...
        $receiptvoucher_result  = $this->receiptvoucher_model->get($id);
        $data['rvlist']         = $receiptvoucher_result;
    ...
    public function delete($id) {
        ...
        $this->receiptvoucher_model->remove($id);
    ...
    public function edit($id) {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($insert_id){
                ...
                $this->receiptvoucher_model->del($insert_id);
                $rvdata = array('voucher_id'=>$insert_id, 'voucher_type'=>'RV');
