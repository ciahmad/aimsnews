...
class Content extends Admin_Controller {
    ...
    function index1() {
        ...
        $data['content_available'] = $this->customlib->contentAvailabelFor();
        $ght = $this->customlib->getcontenttype();
        $list = $this->content_model->get(null, $this->userdata['admin_id']);
        $class = $this->class_model->get(null, null, $this->userdata['admin_id']);
        $data['list'] = $list;
        $data['classlist'] = $class;
        $data['ght'] = $ght;
   ...
   public function handle_upload()
    ...
    function edit($id) {
        ...
        $data['id'] = $id;
        $editpost = $this->content_model->get($id, $this->userdata['admin_id']);
        ...
        $this->form_validation->set_rules('content_title', $this->lang->line('content_title'), 'trim|required|xss_clean');
        if ($this->form_validation->run() == FALSE) {
            $listpost = $this->content_model->get(null, $this->userdata['admin_id']);
    ...
    function search() {
        ...
        $contentlist = $this->content_model->search_by_content_type($text, $this->userdata['admin_id']);
    ...
    function delete($id) {
        ...
        $data = $this->content_model->get($id, $this->userdata['admin_id']);
        $file = $data['file'];
        unlink($file);
    ...
    public function assignment() {
        ...
        if (!$this->rbac->hasPrivilege('assignment', 'can_delete')) {
            access_denied();
        }

        $this->session->set_userdata('menu_heading', 'ACADEMICS');
        $this->session->set_userdata('sub_heading', 'CONTENTS REPORTS');
        $this->session->set_userdata('top_menu', 'Download Center');
        $this->session->set_userdata('sub_menu', 'content/assignment');
        $data['title_list'] = 'Assignment List';
        $list = $this->content_model->getListByCategory("assignments", $this->userdata['admin_id']);
        $data['list'] = $list;
        $this->load->view('layout/header');
        $this->load->view('admin/content/assignment', $data);
        $this->load->view('layout/footer');
    ...
    public function studymaterial() {
        if (!$this->rbac->hasPrivilege('studymaterial', 'can_delete')) {
            access_denied();
        }
        $this->session->set_userdata('menu_heading', 'ACADEMICS');
        $this->session->set_userdata('sub_heading', 'CONTENTS REPORTS');
        ...
        $list = $this->content_model->getListByCategory("study_material", $this->userdata['admin_id']);
        $data['list'] = $list;
        $this->load->view('layout/header');
    ...
    public function syllabus() {
        ...
        $list = $this->content_model->getListByCategory("syllabus", $this->userdata['admin_id']);
        $data['list'] = $list;
        $this->load->view('layout/header');
    ...
    public function other() {
        ...
        if (!$this->rbac->hasPrivilege('other_downloads', 'can_delete')) {
            access_denied();
        }
        $this->session->set_userdata('menu_heading', 'ACADEMICS');
        $this->session->set_userdata('sub_heading', 'CONTENTS REPORTS');
        ...
        $list = $this->content_model->getListByCategory("other_download", $this->userdata['admin_id']);
        $data['list'] = $list;
        $this->load->view('layout/header');
