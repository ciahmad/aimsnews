...
class Certificate extends Admin_Controller {
    ...
    public function index() {
        ...
        $custom_fields = $this->customfield_model->get_custom_fields('students','',$this->userdata['admin_id']);
        $this->data['custom_fields'] = $custom_fields;
        $this->data['certificateList'] = $this->certificate_model->certificateList($this->userdata['admin_id']);
    ...
    function edit($id) {
        ...
        $data['id'] = $id;
        $editcertificate = $this->certificate_model->get($id, $this->userdata['admin_id']);
    ...
    public function view() {
        ...
        $certificate = $this->certificate_model->certifiatebyid($id, $this->userdata['admin_id']);
