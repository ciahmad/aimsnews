...
class Stuattendence extends Admin_Controller {
    ...
    function index() {
        ...
        $sch_setting = $this->setting_model->getSchoolDetail(null, $this->userdata['admin_id']);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $student_list = $this->stuattendence_model->get(null, $this->userdata['admin_id']);
            ...
            $attendencetypes = $this->attendencetype_model->get(null, $this->userdata['admin_id']);
    ...
    function attendencereport() {
       ...
       $role_id =$this->role_model->get(null);

       //print_r($role_id[0]['name']); die();
