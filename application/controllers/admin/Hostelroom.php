...
class Hostelroom extends Admin_Controller {
    ...
    public function index() {
        ...
        $hostellist = $this->hostel_model->get('', $this->userdata['admin_id']);
        $data['hostellist'] = $hostellist;

        $this->session->set_userdata('top_menu', 'Hostel');
        $this->session->set_userdata('sub_menu', 'hostelroom/index');
        $hostelroomlist = $this->hostelroom_model->lists($this->userdata['admin_id']);
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
                $data = array(
                    'hostel_id'=>form_error('hostel_id'),
                    'room_type_id'=>form_error('room_type_id'),
                    'room_no'=>form_error('room_no'),
                    'no_of_bed'=>form_error('no_of_bed'),
                    'cost_per_bed'=>form_error('cost_per_bed'),
                );
    ...
    function getRoom() {
        ...
        $data = $this->hostelroom_model->getRoomByHoselID($hosel_id, $this->userdata['admin_id']);
