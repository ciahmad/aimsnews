...
class Expense extends Admin_Controller {
    ...
    function index() {
        ...
        $invoice_no = $this->expense_model->isInvoiceNoExist();
        ...
        $data['accountheads'] = $this->account_model->getAccountHead(2);
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($insert_id){
                ...
                $expData = array('voucher_id'=>$insert_id, 'voucher_type'=>'EXP');
