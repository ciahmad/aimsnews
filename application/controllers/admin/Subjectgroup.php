...
class Subjectgroup extends Admin_Controller {
    ...
    public function index() {
        ...
        $subject_list = $this->subject_model->get(null, $this->userdata['admin_id']);
        $data['subjectlist'] = $subject_list;
        $subjectgroupList = $this->subjectgroup_model->getByID(null, $this->userdata['admin_id']);
    ...
    public function edit($id) {
        ...
        $data['class_id'] = 0;
        $data['subjectgroupList'] = $subjectgroupList;
        $subjectgroup = $this->subjectgroup_model->getByID($id, $this->userdata['admin_id']);
    ...
    public function getSubjectByClassandSectionDate() {
        ...
        $class_id = $this->input->post('class_id');
        $section_id = $this->input->post('section_id');
        $data = $this->subjecttimetable_model->getSubjectByClassandSectionDay($class_id, $section_id, $day,$this->userdata['admin_id']);
        echo json_encode($data);
    }
