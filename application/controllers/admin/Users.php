...
class Users extends Admin_Controller {
    ...
    function index() {
        ...
        $studentList = $this->student_model->getStudents($this->userdata['admin_id']);
        $staffList = $this->staff_model->getAll_users(null, null, $this->userdata['admin_id']);
    ...
    function admissionreport() {
        ...
        $admission_year = $this->student_model->admissionYear($this->userdata['admin_id']);
        ...
        if ((empty($class_id)) && (empty($year))) {
            ...
            $resultlist = $this->student_model->searchAdmissionDetails($class_id, $year,  $this->userdata['admin_id']);
    ...
    function logindetailreport() {
        ...
        $studentdata = $this->student_model->get(null, $this->userdata['admin_id']);
		$data['sch_setting']        = $this->sch_setting_detail;
		$data['adm_auto_insert']    = $this->sch_setting_detail->adm_auto_insert;
        $this->form_validation->set_rules('class_id', $this->lang->line('class'), 'trim|required|xss_clean');
    ...
    if (isset($_POST["search"])) {
            ...
            $studentdata = $this->student_model->searchByClassSection($class_id, $section_id, $this->userdata['admin_id']);
        }
