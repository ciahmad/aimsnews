...
class Generateidcard extends Admin_Controller {
    ...
    public function index() {
        ...
        $idcardlist = $this->Generateidcard_model->getstudentidcard($this->userdata['admin_id']);
    ...
    public function generate($student, $class, $idcard) {
        ...
        $idcardlist = $this->Generateidcard_model->getidcardbyid($idcard, $this->userdata['admin_id']);
        $data['idcardlist'] = $idcardlist;
    ...
    public function generatemultiple() {
        ...
        $data['id_card'] = $this->Generateidcard_model->getidcardbyid($idcard,$this->userdata['admin_id']);
