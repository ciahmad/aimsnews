...
class Journalvoucher extends Admin_Controller {
   ...
   public function index() {
        ...
        $invoice_no = $this->journalvoucher_model->isInvoiceNoExist();
        ...
        //     $this->form_validation->set_rules('debit', 'Debit', 'trim|required|xss_clean');
        ...
        $journalvoucher_result = $this->journalvoucher_model->get();
    ...
    public function view($id) {
        ...
        $data['id'] = $id;
        $journalvoucher_result  = $this->journalvoucher_model->get($id);
        $data['jvlist']         = $journalvoucher_result;
        ...
        if($data['jvresult']['staff_type'] =='students'){
            
            $studentsLists  = $this->student_model->get($data['jvresult']['staff_std_id']);
    ...
    public function delete($id) {
        ...
        $this->journalvoucher_model->remove($id);
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->input->post('staff_std_id')!='') {
                ...
                if($insert_id){
                    ...
                    $this->journalvoucher_model->del($insert_id);
                    $jvdata = array('voucher_id'=>$insert_id, 'voucher_type'=>'JV');
        ...
        if($this->input->post('action') =='jvmorelist'){
            ...
            for ($i=1; $i <= 2; $i++) { 
               ...
               $data .='<tr id="jv'.$row_id.'">
                    ...
                    <td><input id="description'.$row_id.'" name="description[]" type="text" class="form-control"  value="" style="width: 500px;"/></td>
                    <td><input onchange="sumDebit('.$row_id.')" id="debit'.$row_id.'" name="debit[]" type="text" class="form-control" data-debit="0" value="" style="text-align: right;"/></td>
                    <td><input onchange="sumCredit('.$row_id.')" id="credit'.$row_id.'" name="credit[]" type="text" class="form-control" data-credit="0" value="" style="text-align: right;"/></td>
                </tr>';
            }
