...
class Item extends Admin_Controller {
    ...
    function index() {
        ...
        $item_result = $this->item_model->get('',$this->userdata['admin_id']);

        $data['itemlist'] = $item_result;


        $itemcategory = $this->itemcategory_model->get('',$this->userdata['admin_id']);
    ...
    function edit($id) {
        ...
        $data['id'] = $id;
        $item = $this->item_model->get($id, $this->userdata['admin_id']);
        $data['item'] = $item;
        $item_result = $this->item_model->get('',$this->userdata['admin_id']);
        $data['itemlist'] = $item_result;
