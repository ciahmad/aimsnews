...
class Book extends Admin_Controller {
    ...
    public function index() {
        ...
        $listbook = $this->book_model->listbook($this->userdata['admin_id']);
    ...
    public function getall() {
        ...
        $this->session->set_userdata('menu_heading', 'LIBRARY');
        $this->session->set_userdata('top_menu', 'Library');
        $this->session->set_userdata('sub_menu', 'book/getall');


        $listbook = $this->book_model->bookgetall($this->userdata['admin_id']);
        $data['listbook'] = $listbook;
...
//echo '<pre>';print_r($result); die('generate book number');
                    }
    ...
    public function issue_returnreport() {
        ...
        $data['title'] = 'Add Teacher';
        $teacher_result = $this->teacher_model->getLibraryTeacher($this->userdata['admin_id']);
        $data['teacherlist'] = $teacher_result;

        $genderList = $this->customlib->getGender();
        $data['genderList'] = $genderList;
        $issued_books = $this->bookissue_model->getissuereturnMemberBooks(null, $this->userdata['admin_id']);
        $data['issued_books'] = $issued_books;
