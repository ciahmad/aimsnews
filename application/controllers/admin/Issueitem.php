...
class Issueitem extends Admin_Controller {
    ...
    public function index() {
        ...
        $data['staff'] = $this->staff_model->inventry_staff($this->userdata['admin_id']);



        $data['itemissueList'] = $itemcategory;
       // print_r($data['itemissueList']); die();
    ...
    public function check_available_quantity() {
        ...
        if ($quantity != "" && $item_category_id != "" && $item_id != "") {
            ...
            $data = $this->item_model->getItemAvailable($item_id, $this->userdata['admin_id']);
