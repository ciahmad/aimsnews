...
class Feesforward extends Admin_Controller {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            if ($action == 'search') {
                ...
                if ($this->form_validation->run() == TRUE) {
                    ...
                    $student_due_fee = $this->studentfeemaster_model->addPreviousBal($student_data, $due_date, $this->userdata['admin_id'], $this->userdata['id']);
    ...
    public function findPreviousBalanceFees($session_id, $class_id, $section_id, $current_session) {
        ...
        $studentlist = $this->student_model->getPreviousSessionStudent($session_id, $class_id, $section_id, $this->userdata['admin_id']);
