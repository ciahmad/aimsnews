...
class Notification extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('sub_heading', 'COMMUNICATION');
        $this->session->set_userdata('top_menu', 'Communicate');
        $this->session->set_userdata('sub_menu', 'notification/index');
        $data['title'] = 'Notifications';

        $notifications = $this->notification_model->get(null, $this->userdata['admin_id']);
    ...
    public function edit($id) {
        ...
        $usernotification = $this->notification_model->get($id, $this->userdata['admin_id']);
        ...
        $data['id'] = $id;
        $notification = $this->notification_model->get($id, $this->userdata['admin_id']);
    ...
    public function delete($id) {
        ...
        $this->notification_model->remove($id, $this->userdata['admin_id']);
    ...
    public function addnotifications(){
        ...
        //   print_r($_POST);die;
        //$notificationlist = $this->notificationsetting_model->get(null, $this->userdata['admin_id']);
        //$data['notificationlist'] = $notificationlist;

        $this->form_validation->set_rules('event_type', $this->lang->line('event'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('mail_type', $this->lang->line('option'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('template_message', $this->lang->line('sample_message'), 'trim|required|xss_clean');

        //$this->form_validation->set_rules('event_type', $this->lang->line('event'), 'required');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                $this->notificationsetting_model->save_notification($data);
                $this->session->set_flashdata('msg', '<div class="alert alert-success">' . $this->lang->line('update_message') . '</div>');
        ...
        $data['title'] = 'Email Config List';
        $this->load->view('layout/header', $data);
        $this->load->view('admin/notification/createNotificationSetting', $data);
        $this->load->view('layout/footer', $data);
    ...
    public function setting() {
        ...
        $notificationlist = $this->notificationsetting_model->get(null, $this->userdata['admin_id']);
        $data['notificationlist'] = $notificationlist;
        //print_r($data['notificationlist']);die;
    ...
    public function gettemplate() {
        ...
        $data['record'] = $this->notificationsetting_model->get($id, $this->userdata['admin_id']);
