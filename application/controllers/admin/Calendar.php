...
class Calendar extends Admin_Controller
{
    ...
    //echo '<pre>';    print_r($userdata["id"]); die();
        ...
        $tasklist         = $this->calendar_model->getTask(10, $this->uri->segment(4), $userdata["id"], $userdata["role_id"], $this->userdata['admin_id']);
    ...
    public function getevents()
    {
        ...
        $userdata = $this->customlib->getUserData();
        $result   = $this->calendar_model->getEvents('',$this->userdata['admin_id']);
        if (!empty($result)) {
    ...
    public function view_event($id)
    {
        ...
        $result              = $this->calendar_model->getEvents($id, $this->userdata['admin_id']);
