...
class Member extends Admin_Controller {
    ...
    public function index() {
        ...
        $memberList = $this->librarymember_model->get($this->userdata['admin_id']);
    ...
    //     //print_r($this->userdata['admin_id']); die;
    ...
    //                     $resultlist = $this->student_model->searchLibraryStudent($class, $section, $this->userdata['admin_id']);
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            ...
            if (isset($search)) {
                if ($search == 'search_filter') {
                    ...
                    $data['section_id'] = $this->input->post('section_id');
                    $data['search_text'] = trim($this->input->post('search_text'));
                    $resultlist = $this->student_model->searchFullText($search_text, $this->userdata['admin_id']);
                    $data['resultlist'] = $resultlist;
                }
            }
            $this->load->view('layout/header', $data);
