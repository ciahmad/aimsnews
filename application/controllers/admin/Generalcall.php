...
class Generalcall extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $data['CallList'] = $this->general_call_model->call_list('', $this->userdata['admin_id']);
        $this->load->view('layout/header');
        $this->load->view('admin/frontoffice/generalcallview', $data);
        $this->load->view('layout/footer');
    }

    public function add_generalcall()
    {
        // if (!$this->rbac->hasPrivilege('phone_call_log', 'can_view')) {
        //     access_denied();
        // }
    ...
    function edit($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['CallList'] = $this->general_call_model->call_list('', $this->userdata['admin_id']);
            $data['Call_data'] = $this->general_call_model->call_list($id, $this->userdata['admin_id']);
            $this->load->view('layout/header');
