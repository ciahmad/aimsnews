...
class Transaction extends Admin_Controller {
    ...
    function searchtransaction() {
        ...
        $expenseList = $this->expense_model->search("", $date_from, $date_to, $this->userdata['admin_id']);

        $result = $this->payroll_model->getbetweenpayrollReport($date_from, $date_to);

        $incomeList = $this->income_model->search("", $date_from, $date_to, $this->userdata['admin_id']);
    ...
    function studentacademicreport() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $classlist = $this->student_model->getAllClassSection($class_id, $section_id, $this->userdata['admin_id']);
           // print_r($classlist); die('class list');
