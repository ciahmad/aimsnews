...
class Onlineexam extends Admin_Controller {
    ...
    public function index() {
        ...
        $questionList = $this->onlineexam_model->get(null,null,$this->userdata['admin_id']);
    ...
    public function assign($id) {
        ...
        $onlineexam = $this->onlineexam_model->get($id,null,$this->userdata['admin_id']);
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            $resultlist = $this->onlineexam_model->searchOnlineExamStudents($data['class_id'], $data['section_id'], $data['onlineexam_id'], $this->userdata['admin_id']);
