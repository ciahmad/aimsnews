...
class Itemcategory extends Admin_Controller {
    ...
    function index() {
        ...
        $category_result = $this->itemcategory_model->get('', $this->userdata['admin_id']);
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data = array(
                'itemcategory'=>form_error('itemcategory')
            );
    ...
    function edit($id) {
        ...
        $data['categorylist'] = $category_result;
        $data['id'] = $id;
        $category = $this->itemcategory_model->get($id,$this->userdata['admin_id']);
