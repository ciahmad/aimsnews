...
class approve_leave extends Admin_Controller {
    ...
    function index() {
        ...
        $data['results'] = array();
        $listaudit = $this->apply_leave_model->get(null, null, null,  $this->userdata['admin_id']);
        //print_r($listaudit); die;
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $listaudit = $this->apply_leave_model->get(null, $class_id, $section_id,  $this->userdata['admin_id']);
        }
