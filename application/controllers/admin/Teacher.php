...
class Teacher extends Admin_Controller {
    ...
    public function index() {
        ...
        $teacher_result = $this->teacher_model->get(null, $this->userdata['admin_id']);
    ...
    public function assignteacher() {
        ...
        $teacherlist = $this->staff_model->getStaffbyrole($teacher_role_id['id'], $this->userdata['admin_id']);
        $data['teacherlist'] = $teacherlist;

        $subject = $this->subject_model->get(null, $this->userdata['admin_id']);
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            foreach ($loop as $key => $value) {
                $s = array();
                $s['session_id'] = $this->setting_model->getCurrentSession($this->userdata['admin_id']);
                $class_id = $this->input->post('class_id');
                $section_id = $this->input->post('section_id');
                $dt = $this->classsection_model->getDetailbyClassSection($class_id, $section_id);

                $s['class_section_id'] = $dt['id'];
                $s['admin_id'] = $this->userdata['admin_id'];
                $s['created_by'] = $this->userdata['id'];
    ...
    public function view($id) {
        ...
        $teacher = $this->teacher_model->get($id, $this->userdata['admin_id']);
    ...
    public function assign_class_teacher() {
        ...
        $this->form_validation->set_rules('class', $this->lang->line('class'), array( 'required',
        ...
        $classlist = $this->class_model->get(null, null, $this->userdata['admin_id']);
        $data['classlist'] = $classlist;

        $sectionlist = $this->section_model->get(null, $this->userdata['admin_id']);
        $data['sectionlist'] = $sectionlist;

        $assignteacherlist = $this->class_model->getClassTeacher($this->userdata['admin_id']);
        //echo '<pre>'; print_r($assignteacherlist); die();
        ...
        foreach ($assignteacherlist as $key => $value) {
            ...
            $tlist[] = $this->classteacher_model->teacherByClassSection($class_id, $section_id, $this->userdata['admin_id']);
        }
        if (!empty($tlist)) {
            $data["tlist"] = $tlist;
        }
    ...
    public function update_class_teacher($class_id, $section_id) {
        ...
        if ($this->form_validation->run() == false) {
            $result = $this->classteacher_model->teacherByClassSection($class_id, $section_id, $this->userdata['admin_id']);
            ...
            foreach ($assignteacherlist as $key => $value) {
                ...
                $tlist[] = $this->classteacher_model->teacherByClassSection($classid, $sectionid, $this->userdata['admin_id']);
            }
