...
class Staffattendance extends Admin_Controller {
    ...
    function index() {
        ...
        $user_type = $this->staff_model->getStaffRole(null);
        ...
        if (!(isset($user_type_id))) {
            ...
            $user_list = $this->staffattendancemodel->get(null, $this->userdata['admin_id']);
            ...
            $attendencetypes = $this->attendencetype_model->getStaffAttendanceType(null);
            //echo '<pre>';  print_r($attendencetypes); die();
            $data['attendencetypeslist'] = $attendencetypes;
            $resultlist = $this->staffattendancemodel->searchAttendenceUserType($user_type, date('Y-m-d', $this->customlib->datetostrtotime($date)), $this->userdata['admin_id']);
