...
class Userlog extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->session->set_userdata('top_menu', 'userlog Report');
        $this->session->set_userdata('sub_menu', 'Reports/userlog');

        $userlogList = $this->userlog_model->get(null,$this->userdata['admin_id']);
        
        $data['userlogList'] = $userlogList;
        $data['userlogStaffList'] = $this->userlog_model->getByRoleStaff($this->userdata['admin_id']);
        
        $data['userlogStudentList'] = $this->userlog_model->getByRole('student',$this->userdata['admin_id']);
        
        $data['userlogParentList'] = $this->userlog_model->getByRole('parent',$this->userdata['admin_id']);
       // print_r($data); die();
