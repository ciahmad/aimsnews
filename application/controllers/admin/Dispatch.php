...
class Dispatch extends Admin_Controller {
    ...
    public function index() {
        ...
        //     access_denied();
        // }
        $data['DispatchList'] = $this->Dispatch_model->dispatch_list($this->userdata['admin_id']);
    ...
    function editdispatch($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['DispatchList'] = $this->Dispatch_model->dispatch_list($this->userdata['admin_id']);
            $data['Dispatch_data'] = $this->Dispatch_model->dis_rec_data($id, 'dispatch',$this->userdata['admin_id']);
            $this->load->view('layout/header');
