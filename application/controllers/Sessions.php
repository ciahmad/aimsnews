...
class Sessions extends Admin_Controller {
    ...
    function index() {
        ...
        $session_result = $this->session_model->getAllSession($this->userdata['admin_id']);
    ...
    function view($id) {
        ...
        $data['title'] = 'Session List';
        $session = $this->session_model->get($id, $this->userdata['admin_id']);
    ...
    function delete($id) {
        ...
        $this->session_model->remove($id, $this->userdata['admin_id']);
    ...
    function create() {
        ...
        $session_result = $this->session_model->getAllSession($userdata['admin_id']);
        $data['sessionlist'] = $session_result;
