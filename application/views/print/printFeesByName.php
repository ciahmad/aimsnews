                    ...
                    <div class="invoice">
                        <div class="row header" style="margin-top:20px">                          
                            ...
                            if ($settinglist[0]['is_duplicate_fees_invoice']) {
                                ?>
                                <div class="row text text-center" style="padding-top:0px; margin-top:0px">
                                        <div class="col-sm-12 feeprint" style="background-color:black; color:white">Fee Receipt </div>
                                </div>
                                <div class="row">
                    ...
                    if ($settinglist[0]['is_duplicate_fees_invoice']) {
                        ...
                        <div class="invoice">
                                <div class="row header" style="margin-top:20px">                          
                                    ...
                                    <div class="col-sm-10 text text-left" style="padding-top:20px">
                                        <h4 style=""><?php echo $stting[0]['name']?></h4>
                                        <p style="margin-top:0px;   padding-top:0px; margin-bottom:0px; padding-bottom:0px"><?php echo $stting[0]['address']?></p>
                                        <p style="margin-top:0px; padding-top:0px">Contact # <?php echo $stting[0]['phone']?></p>
                                    </div>
