    ...
    <body>       
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="invoice">
                        <div class="row header" style="margin-top: 20px;">
                            <div class="col-sm-2 text text-right">                              
                                ...
                                ?>
                                <image src="<?php echo base_url();?>uploads/school_content/logo/<?php echo $stting[0]['image']?>" style="width:100px" alt="Institute's Logo Not Found ">
                               
                            </div>
                            <div class="col-sm-10 text text-left" style="padding-top:25px">
                                <h4 style="margin-bottom:0px; padding-bottom:0px"><?php echo $stting[0]['name']?></h4>
                                <p style="margin-top:0px;   padding-top:0px; margin-bottom:0px; padding-bottom:0px"><?php echo $stting[0]['address']?></p>
                                <p style="margin-top:0px; padding-top:0px">Contact # <?php echo $stting[0]['phone']?></p>
                            </div>
                            <?php if ($settinglist[0]['is_duplicate_fees_invoice']) { ?>
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    <div class="col-sm-12 feeprint text-center" style="background-color:black; color:white">Fee Receipt </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="row">                           
                                ...
                                <div class="col-xs-4 text-right">
                                    <?php
                                                 $filename = 'temp/'.$feearray[0]->admission_no.'.png';
                                    ...
                                    if (isset($_REQUEST['size']))
                                        $matrixPointSize = min(max((int)$_REQUEST['size'], 1), 10);
                                                                    ...
                                                                    //default data  
                                        QRcode::png('Fee Voucher - '. $feearray[0]->firstname . " " . $feearray[0]->lastname, $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
                                        
                                        
                                        $link = "http://".$_SERVER['HTTP_HOST']."/";
                                     echo '<img src="'.$link.$PNG_WEB_DIR.basename($filename).'"  />';    ?>                       
                                </div>
                                                    ...
                                                    <tr  class="dark-gray">
                                                        ...
                                                        <td class="">
                                                            ...
                                                            if ($feeList->due_date == "0000-00-00") {
                                                                ...
                                                                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($feeList->fee_due_date));
                                                            }
                                                            ?>
                                                        </td>
                                                        <td class="">
                ...
                <div class="row">
                                    <div class="col-sm-12 scissorsdiv"></div>
                                </div>
                <?php
                if ($settinglist[0]['is_duplicate_fees_invoice']) {
                    ...
                    <div class="row">
                        <div id="content" class="col-lg-12 col-sm-12 ">
                            <div class="invoice">
                            <div class="row header" style="margin-top:20px !important;">
                            <div class="col-sm-2 text text-right">                              
                                <?php
                                $this->userdata = $this->customlib->getuserdata();
                                $stting = $this->setting_model->get(null, $this->userdata['admin_id']);
                            ...
                            <div class="col-sm-10 text text-left" style="padding-top:25px">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    <div class="col-sm-12 feeprint text text-center" style="background-color:black; color:white">Fee Receipt </div>
                                </div>
                                ...
                                <div class="col-xs-4 text-right">
                                    ...
                                    if (isset($_REQUEST['size']))
                                        $matrixPointSize = min(max((int)$_REQUEST['size'], 1), 10);
                                                                    ...
                                                                    //default data  
                                        QRcode::png('Fee Voucher - '. $feearray[0]->firstname . " " . $feearray[0]->lastname, $filename, $errorCorrectionLevel, $matrixPointSize, 0.5);    
