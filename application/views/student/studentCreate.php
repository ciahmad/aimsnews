            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools impbtntitle">
                        <?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) { ?>
                            <a href="<?php echo site_url('student/import') ?>">
                                <button class="btn btn-primary btn-sm themecolor"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import_student'); ?></button>
                            </a>
                        <?php }
                        ?>
                    </div>
                    <form id="form1" action="<?php echo site_url('student/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="">
                            <div class="bozero">
                                <h4 class="pagetitleh-whitebg themecolor"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admission'); ?> </h4>
                                <div class="around10">
...
<?php if ($sch_setting->bank_account_no) { ?>
                                                <div class="row around10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('bank_branch_code'); ?></label>
...
<?php if ($sch_setting->local_identification_no) { ?>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo $this->lang->line('bank_title'); ?>
                                                            </label>
...
<?php } ?>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info btn-sm pull-right themecolor"><?php echo $this->lang->line('save'); ?></button>
                                <a style="margin-right:10px" href="<?php echo base_url('student/search'); ?>" class="btn btn-info btn-sm pull-right themecolor"><li class="fa fa-arrow-circle-o-left"></li> &nbsp Back</a>  
                            </div>
                    </form>
                </div>
            </div>
