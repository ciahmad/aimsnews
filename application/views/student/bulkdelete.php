            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="box-title"><i class="fa fa-search"></i>Bulk Delete</h3>
                            </div>
                            <div class="col-md-6 text-right"><a style="float: right; color: #fff" href="<?php echo base_url('admin/schoolhouse');?>"><i class="fa fa-backward"></i>Back</a></div>
                        </div>                        
                    </div>
                    <div class="box-body">
                        <div class="row">  
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php echo $this->lang->line('bulk') . " " . $this->lang->line('delete') ?>
                                            ...
                                            if (!empty($resultlist)) {
                                                ?>                              
                                                <button type="submit" class="btn btn-primary pull-right btn-sm mt10 themecolor" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait..."> <?php echo $this->lang->line('delete') ?></button>
                                                <?php
                                            }
                                            ?>
