            ...
            <div class="col-md-12">
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('student_information'); ?> Information</h3>
                        <div class="pull-right box-tools">                            
                            <a href="<?php echo site_url('student/exportformat') ?>">
                                <button class="btn btn-primary btn-sm themecolor"><i class="fa fa-download"></i> <?php echo $this->lang->line('dl_sample_import'); ?></button>
                            </a>
                        </div>
                    </div>
                    <div class="box-body">      
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt20">
                                    <button type="submit" class="btn btn-info pull-right btn-sm themecolor"><?php echo $this->lang->line('import_student'); ?></button>
                                    <a style="margin-right:10px" href="<?php echo base_url('student/create'); ?>" class="btn btn-info btn-sm pull-right themecolor"><li class="fa fa-arrow-circle-o-left"></li> &nbsp Back</a>                                    
                                </div>     
