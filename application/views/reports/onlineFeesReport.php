            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header with-border aimsreportsbg">
                        <h3 class="box-title"><i class="fa fa-search"></i>Online Fee Collection Report <?php //echo $this->lang->line('select_criteria'); ?></h3>
                    </div>
                    ...
                    <div class="">
                        ...
                        <div class="download_label ">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php
                                  echo $this->lang->line('online') . " " . $this->lang->line('fees') . " " . $this->lang->line('report') . "<br>";
