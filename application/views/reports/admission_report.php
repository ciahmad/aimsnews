                ...
                <div class="box removeboxmius">
                    ...
                    <form  action="<?php echo site_url('report/admission_report') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" role="status" class="btn btn-sm  pull-right themecolor"><i class="fa fa-search"></i> <span class="sr-only"></span> <?php echo $this->lang->line('search'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
