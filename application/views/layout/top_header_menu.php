     ...
     <div class="container-xxl d-flex align-items-stretch justify-content-between">
         ...
         <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
             <a href="../../demo1/dist/index.html">
                 <img alt="Logo" src="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo($result['admin_id']); ?>" class="h-20px h-lg-30px" />
             </a>
         </div>
         <!--end::Logo-->
         <!--begin::Wrapper-->
                     ...
                     <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                         ...
                         <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-lg-1">
                             ...
                             <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                 ...
                                 <div class="menu-item">
                                     <a class="menu-link" href="<?= base_url('admin/enquiry'); ?>">
                                         <span class="p-1">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                 ...
                                 <div class="row" data-kt-menu-dismiss="true">
                                     ...
                                     <div class="col-lg-4 border-left-lg-1">
                                         <div class="menu-inline menu-column menu-active-bg">
                                             <div class="menu-item">
                                                 <a href="<?= base_url('admin/hostelroom');?>" class="menu-link">
                                                     <span class="menu-bullet">
                                                         <span class="bullet bullet-dot"></span>
                                                     </span>
                                             ...
                                             <div class="menu-item">
                                                 ...
                                                 ?>
                                                 <a href="<?= base_url('admin/route');?>" class="menu-link">
                                                     <span class="menu-bullet">
                                                         <span class="bullet bullet-dot"></span>
                                                     </span>
                                                     <span class="menu-title"><?= $this->lang->line('transport');?></span>
                                                 </a> <?php //} ?>
                                             </div>
                                             <div class="menu-item">
                                                 <a href="<?= base_url('admin/issueitem') ?>" class="menu-link">
                                                     <span class="menu-bullet">
                                                         <span class="bullet bullet-dot"></span>
                                                     </span>
                                                     <span class="menu-title"><?= $this->lang->line('inventory')?></span>
                                                 </a>
                                             </div>
                                             <div class="menu-item">
             ...
             <div class="d-flex align-items-stretch flex-shrink-0">
                 ...
                 <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                     ...
                     <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                         <img src="<?php echo base_url(); ?>assets/media/avatars/300-1.jpg" alt="user" />
                     </div>
