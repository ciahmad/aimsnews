                                            ...
                                            <div class="timeline-content mb-10 mt-n1">
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                                        ...
                                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                            <!--begin::Icon-->
                                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url(); ?>assets/media/svg/files/doc.svg" />
                                                            <!--end::Icon-->
                                                            <!--begin::Info-->
                                                            <div class="ms-1 fw-bold">
                                                                <!--begin::Desc-->
                                                        ...
                                                        <div class="d-flex flex-aligns-center">
                                                            <!--begin::Icon-->
                                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3" src="<?php echo base_url(); ?>assets/media/svg/files/css.svg" />
                                                            <!--end::Icon-->
                                                            <!--begin::Info-->
                                                            <div class="ms-1 fw-bold">
                                                                <!--begin::Desc-->
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="row g-5">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo17.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo18.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo19.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo20.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo21.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo22.png" alt="demo" class="w-100" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                                        <div class="overlay-wrapper">
                                                            <img src="<?php echo base_url(); ?>assets/media/demos/demo24.png" alt="demo" class="w-100 opacity-25" />
                                                        </div>
                                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                                            <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                                        </div>
                    ...
                    <script src="<?php echo base_url(); ?>assets/js/custom/documentation/documentation.js"></script>
                    <script src="<?php echo base_url(); ?>assets/js/custom/documentation/search.js"></script>
                    <script src="<?php echo base_url(); ?>assets/js/custom/documentation/general/datatables/buttons.js"></script>
                    ...
                    <!-- <script src="<?php echo base_url(); ?>assets/js/custom/documentation/forms/daterangepicker.js"></script> -->
