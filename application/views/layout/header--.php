...
<html <?php echo $this->customlib->getRTL(); ?>>
    <head>
       ...
       <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo($result['admin_id']);?>" rel="shortcut icon" type="image/x-icon">
        ...
        <?php
         ...
         <!-- Font Awesome -->
  <link rel="stylesheet" href="<?= base_url()?>backend/plugins/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url()?>backend/dist/css/adminlte.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= base_url()?>backend/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url()?>backend/plugins/morris/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?= base_url()?>backend/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Date Picker -->
  <!-- <link rel="stylesheet" href="<?= base_url()?>backend/plugins/datepicker/datepicker3.css"> -->
  <!-- Daterange picker -->
  <!-- <link rel="stylesheet" href="<?= base_url()?>backend/plugins/daterangepicker/daterangepicker-bs3.css"> -->
  <!-- bootstrap wysihtml5 - text editor -->
  <!-- <link rel="stylesheet" href="<?= base_url()?>backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css"> -->
  <!-- DropZone -->
  <link rel="stylesheet" href="<?= base_url()?>backend/plugins/dropzone/dropzone.css">
       ...
       <div class="wrapper">
            ...
            <header class="main-header" id="alert">
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">
                    <span class="logo-mini"><img src="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo($result['admin_id']);?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                    <span class="logo-lg"><img src="<?php echo base_url(); ?>uploads/school_content/admin_logo/<?php $this->setting_model->getAdminlogo($result['admin_id']);?>" alt="<?php echo $this->customlib->getAppName() ?>" /></span>
                </a>
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="col-lg-4 col-md-3 col-sm-2 col-xs-5">
                        <span href="#"  class="sidebar-session">
                            <?php echo $this->setting_model->getCurrentSchoolName($result['admin_id']); ?>
                        </span>
                    </div>
                    
                    <div class="col-lg-8 col-md-9 col-sm-10 col-xs-7">
...
$file   = "";
$result = $this->customlib->getUserData();
//echo "<pre>"; print_r($result["user_type"]);echo "</pre>";
$image = $result["image"];
                                            ...
                                            <li>
                                                <div class="sstopuser">
                                                    ...
                                                    <?php if($role =='Admin' || $role=='Super Admin'){?>
                                                        <a href="<?php echo base_url() . "admin/adminprofile/profile/" . $id ?>"><img src="<?php echo base_url() . $file; ?>" alt="User Image"></a>
                                                    <?php }else if($role =='staff'){?>
                                                        <a href="<?php echo base_url() . "admin/staff/profile/" . $id ?>"><img src="<?php echo base_url() . $file; ?>" alt="User Image"></a>
                                                    <?php }else{ ?>
                                                        <a href="<?php echo base_url() . "student/view/" . $id ?>"><img src="<?php echo base_url() . $file; ?>" alt="User Image"></a>
                                                    <?php }?>    
                                                    ...
                                                    <div class="sspass">
                                                        ...
                                                        <a href="<?php echo base_url() . "admin/adminprofile/profile/" . $id ?>" data-toggle="tooltip" title="" data-original-title="My Profile"><i class="fa fa-user"></i>Profile</a>
                                                        ...
                                                        <a class="pl25" href="<?php echo base_url(); ?>admin/admin/changepass" data-toggle="tooltip" title="" data-original-title="Change Password"><i class="fa fa-key"></i><?php echo $this->lang->line('password'); ?></a> <a class="pull-right" href="<?php echo base_url(); ?>site/logout"><i class="fa fa-sign-out fa-fw"></i><?php echo $this->lang->line('logout'); ?></a>
                                                        <?php }else{ ?>
                                                        <a href="<?php echo base_url() . "client/view/" . $id ?>" data-toggle="tooltip" title="" data-original-title="My Profile"><i class="fa fa-user"></i>Profile</a>
                                                        <a class="pl25" href="<?php echo base_url(); ?>admin/admin/changepass" data-toggle="tooltip" title="" data-original-title="Change Password"><i class="fa fa-key"></i><?php echo $this->lang->line('password'); ?></a> <a class="pull-right" href="<?php echo base_url(); ?>site/logout"><i class="fa fa-sign-out fa-fw"></i><?php echo $this->lang->line('logout'); ?></a>
                                                        <?php }?>
                                                    </div>
                                                </div><!--./sstopuser--></li>
