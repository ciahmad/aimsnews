<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('casesubcategory', 'can_add')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_sub_category'); ?></h3>
                        </div> 
                        <form action="<?php echo site_url('casesubcategory/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th> Sr No</th>
                                        <th><?php echo $this->lang->line('case_sub_category'); ?></th>
                                    ...
                                    foreach ($sectionlist as $section) {
                                        ...
                                        <td class="mailbox-name"> <?php echo $section['section'] ?></td>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                <?php
                                                if ($this->rbac->hasPrivilege('casesubcategory', 'can_edit')) {
                                                    ?>
