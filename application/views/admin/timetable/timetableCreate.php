                ...
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right"><a style="float: right; color: #fff" href="<?php echo base_url('sections');?>"><i class="fa fa-backward"></i>Back</a></div>
                        </div>                       
                    ...
                    <form action="<?php echo site_url('admin/timetable/create') ?>" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary pull-right btn-sm themecolor"><?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
