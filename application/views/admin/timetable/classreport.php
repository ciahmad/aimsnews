            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('class').''.$this->lang->line('timetable'); ?></h3>
                        <div class="box-tools pull-right">
                            <a href="<?php echo site_url('admin/timetable/create') ?>" type="button"  class="btn btn-sm btn-primary themecolor" autocomplete="off"><i class="fa fa-plus"></i> Add</a>
                        </div>
                    </div>
                    <form action="<?php echo site_url('admin/timetable/classreport') ?>" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            <button type="submit" style="margin-left:6px;" class="btn btn-primary pull-right btn-sm themecolor" name="search"><?php echo $this->lang->line('search'); ?></button>
                            <a class="btn btn-primary pull-right btn-sm themecolor" style="float: left; color: #fff" href="<?php echo base_url('sections');?>"><i class="fa fa-backward"></i>Back</a>
                        </div>
                    </form>
