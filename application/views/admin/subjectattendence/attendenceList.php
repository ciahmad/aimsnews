            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border aimsreportsbg">
                        <h3 class="box-title"><i class="fa fa-search"></i>Period Attendance</h3>
                    </div>
                    <form id='form1' action="<?php echo site_url('admin/subjectattendence') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="download_label">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    <div class="col-sm-12 feeprint text text-center" style="background-color:black; color:white">Period Attendance
                                    <?php //echo $this->lang->line('disable') . " " . $this->lang->line('student') . " " . $this->lang->line('list') ?>
                                    </div>
                                </div>
                            </div>
                            <?php
                                        ...
                                        <div class="mailbox-controls">
                                            <span class="button-checkbox">
                                                <?php if ($this->rbac->hasPrivilege('student_attendance', 'can_add')) { ?>
                                                    <button type="button" class="btn btn-sm btn-primary themecolor" data-color="primary"><?php echo $this->lang->line('mark_as_holiday'); ?></button>
                                                ...
                                                if ($can_edit == 1) {
                                                    if ($this->rbac->hasPrivilege('student_attendance', 'can_add')) {
                                                        ?>
                                                        <button type="submit" name="search" value="saveattendence" class="btn btn-primary btn-sm pull-right checkbox-toggle themecolor"><i class="fa fa-save"></i> <?php echo $this->lang->line('save_attendance'); ?> </button>
                                                    <?php }
                                                }
                                                ?>
                                            </div>
