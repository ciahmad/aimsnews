                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('deactivation') . " " . $this->lang->line('reason'); ?></h3>
                        </div> 
            ...
            ?>">             
                <div class="box box-primary">
                    <div class="box-header ptbnull themecolor">
                        <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('deactivation') . " " . $this->lang->line('reason') . " " . $this->lang->line('list'); ?></h3>                
                    </div>
                    <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($results as $value) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right" style="float:right !important"><a data-placement="left" class="btn btn-default btn-xs" href="<?php echo base_url(); ?>admin/disable_reason/edit/<?php echo $value['id']; ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-edit text-green"></i></a>

                                                <a data-placement="left" onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>')" class="btn btn-default btn-xs" href="<?php echo base_url() ?>admin/disable_reason/delete/<?php echo $value['id'] ?>" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash text-danger"></i></a></td>
