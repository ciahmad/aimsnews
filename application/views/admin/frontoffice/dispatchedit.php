                        ...
                        <form id="form1" action="<?php echo site_url('admin/dispatch/editdispatch/' . $Dispatch_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <textarea class="form-control" id="description"  name="address" rows="1"><?php echo set_value('address', $Dispatch_data['address']); ?></textarea>
                                    ...
                                    <textarea class="form-control" id="description" name="note" name="note" rows="1"><?php echo set_value('note', $Dispatch_data['note']); ?></textarea>
                                </div>
                                    </div>
                                    <div class="col-sm-3">
                                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header themecolor">
                ...
                <h4 class="modal-title">Postal Dispatch<?php //echo $this->lang->line('details'); ?></h4>
            </div>
