                        ...
                        <form id="form1"  action="<?php echo site_url('admin/receive/editreceive/' . $receiveData['id']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <textarea class="form-control" id="description"  name="address" rows="1"><?php echo set_value('address', $receiveData['address']); ?></textarea>
                                </div>
                                    </div>
                                    <div class="col-sm-3">
                                    <div class="form-group">
                                    <label for="email"><?php echo $this->lang->line('note'); ?></label> 
                                    <textarea class="form-control" id="description" name="note" name="note" rows="1"><?php echo set_value('note', $receiveData['note']); ?></textarea>
                                </div>
                                    </div>
                                    <div class="col-sm-3">
                                    <div class="form-group">
                ...
                <div class="box box-primary">
                    ...
                    <div class="download_label ">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php //echo $this->lang->line('list'); ?> Postal Receive
                            </div>
                            </div>
                        </div>
