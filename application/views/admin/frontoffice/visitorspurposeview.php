    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Visitor Purpose</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="javascript:" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Purpose</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <div id="kt_ecommerce_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        ...
                                        <tbody class="fw-bold">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""><?= $value['visitors_purpose'] ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px !important; background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h4 class="fw-bolder">Add Purpose</h4>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-12 fv-row">
                                        <label for="floatingPassword" class="required"><?= $this->lang->line('visitors_purpose');  ?></label>
                                        <input type="text" id="visitors_purpose" name="visitors_purpose" autocomplete="off" value="" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/visitorspurpose/add_purpose") ?>',
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    $('#visitors_purpose, #description').val("");
