<style>
    td {padding-top: 0.25rem !important; padding-bottom: 0.25rem !important;}
    th { padding-top: 10px !important; padding-bottom: 10px !important;}
</style>
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Reference</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Reference</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px">Reference Name</th>
    ...
    <div class="modal fade" id="kt_modal_add_reference" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Modal header-->
                <div class="modal-header" style="padding: 10px; background:#F1BC00" id="data-kt-users-modal-action">
                    <!--begin::Modal title-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-12 fv-row">
                                        <label for="floatingPassword" class="required"><?= $this->lang->line('reference');  ?></label>
                                        <input type="text" id="reference" name="reference" autocomplete="off" value="" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true" required>
