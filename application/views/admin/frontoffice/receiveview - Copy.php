                        ...
                        <form id="form1" action="<?php echo site_url('admin/receive') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <textarea class="form-control" id="description"  name="address" rows="1"><?php echo set_value('address'); ?></textarea>
                                    ...
                                    <textarea class="form-control" id="description" name="note" name="note" rows="1"><?php echo set_value('note'); ?></textarea>
                                </div>
                                    </div>
                                    <div class="col-sm-3">
                                    <div class="form-group">
                ...
                <div class="box box-primary">
                    ...
                    <div class="download_label ">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php echo $this->lang->line('postal_receive'); ?> <?php echo $this->lang->line('list'); ?>
                            </div>
                            </div>
                        </div>
                        <div class="download_label ">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                <div  class="col-sm-12 feeprint text text-center" style="background-color:black; color:white">
                                <?php echo $this->lang->line('postal_dispatch'); ?><?php echo $this->lang->line('list'); ?>
                            </div>
                            </div>
                        </div>
                        <!-- <div class="download_label">
                                        ...
                                        foreach ($ReceiveList as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right" style="float:right !important">
                                                    ...
                                                    <a data-placement="left" onclick="getRecord(<?php echo $value->id; ?>)" class="btn btn-default btn-xs" data-target="#receviedetails" data-toggle="modal"  title="View"><i class="fa fa-eye text-black"></i></a>
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header themecolor">
                ...
                <h4 class="modal-title">Postal Receive<?php //echo $this->lang->line('details'); ?></h4>
            </div>
