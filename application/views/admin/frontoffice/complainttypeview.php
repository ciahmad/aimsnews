    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Complain Type</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="javascript:" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Complain Type</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                            ...
                                            <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                                ...
                                                <tbody class="fw-bold">
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td style=""><?= $value['complaint_type'] ?></td>
    ...
    <div class="modal fade" id="kt_modal_add_reference" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Modal header-->
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px !important; background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Complain Type</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <form id="kt_modal_add_reference_form" class="form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-12 fv-row">
                                        ...
                                        <input type="text" id="complain_type" name="complain_type" autocomplete="off" value="" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">

                                        <span class="text-danger"></span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!-- <label class="required fw-bold fs-6 mb-2"><?php echo $this->lang->line('complain_type'); ?></label> -->
                                <!--end::Label-->
                                <!--begin::Input-->
                                <!-- <input type="text" name="complain_type" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Complain Type" /> -->

                                <!-- <input type="text" id="complain_type" name="complain_type" autocomplete="off" placeholder="Complain Type" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true"> -->
                                <!--end::Input-->
                            </div>
                            ...
                            <div class="row">
                                <!--begin::Col-->
                                <div class="input-contain col-lg-12 fv-row">
                                    <label for="floatingPassword" class=""><?= $this->lang->line('description');  ?></label>
                                    <input type="text" id="description" name="description" autocomplete="off" value="" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    <span class="text-danger"></span>
                                </div>
                                <!--end::Col-->
                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            <!-- <button type="reset" data-bs-toggle="modal" class="btn btn-light btn-active-light-primary me-2">Discard</button>
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/complainttype/add_complain_type") ?>',
            type: 'POST',
