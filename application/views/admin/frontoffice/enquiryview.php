            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('enquiry').' '.$this->lang->line('list'); ?></h3>  
                            </div>
                            <div class="col-md-6">
                            <a class="pull-right themecolor" style="float: left; border:none" href="<?php echo base_url('admin/visitors');?>"><i class="fa fa-backward"></i>Back</a>
                            </div>
                        </div>                        
                    </div>
                    <div class="col-md-12">
                    ...
                    <form role="form" action="<?php echo site_url('admin/enquiry') ?>" method="post" class="">
                        <div class="box-body row">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right themecolor" style="border: 2px solid white"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                </div>
                            </div>
                        </div>     
                    </form>
                    <div class="ptt10">
                        ...
                        <div class="bordertop">
                            <div class="box-header with-border garnishbg">
                                ...
                                <div class="box-tools pull-right">
                                    <?php if ($this->rbac->hasPrivilege('admission_enquiry', 'can_add')) { ?>
                                        <button type="button" class="btn btn-sm btn-primary" style="background:#00a65a; border:2px solid white" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button> 
                                    <?php } ?>      
                                </div><!-- /.box-tools -->
                            </div><!-- /.box-header -->
                            <div class="box-body">
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php echo $this->lang->line('admission_enquiry'); ?> <?php echo $this->lang->line('list'); ?>
                            </div>
                            </div>
                        </div>
                                <!-- <div class="download_label">
                                ...
                                <div class="mailbox-messages">
                                    <div class="table-responsive">  
                                        <table class="table table-hover table-striped" id="enquirytable">
                                            <thead>
                                                <tr>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-media-content">
                <div class="modal-header modal-media-header themecolor">
                ...
                <div class="modal-body pt0 pb0">
                    ...
                    <div class="row">    
                        <div class="box-footer col-md-12">
                            ...
                            <a  onclick="saveEnquiry()" class="btn btn-info pull-right themecolor"><?php echo $this->lang->line('save'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
