                            ...
                            <table class="table table-hover table-striped  example">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="print_action_button"  class="text-right"><?php echo $this->lang->line('action'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if (empty($visitor_list)) {
                                        ...
                                        foreach ($visitor_list as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right print_action_button" style="float:right !important">
                                                    <a data-placement="left"  onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs text-green" data-target="#visitordetails" data-toggle="modal"  title="<?php echo $this->lang->line('view'); ?>"> <i class="fa fa-eye text-black"></i></a> 
                                                    <?php if ($value['image'] !== "") { ?>
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header themecolor">
                ...
                <h4 class="modal-title">Visitor <?php echo $this->lang->line('details'); ?></h4>
            </div>
