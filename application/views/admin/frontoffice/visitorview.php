    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Visitor Book</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="javascript:" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Create Visitor</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        ...
                                        <tbody class="fw-bold">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style=""><?= $value['purpose'] ?></td>

                                                        <td style=""> <?= $value['name'] ?></td>
                                                        <td style=""> <?= $value['contact'] ?></td>
                                                        <td style=""> <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($value['date'])); ?></td>
                                                        <td style=""> <?php echo $value['in_time']; ?></td>
                                                        <td style=""> <?= $value['out_time'] ?></td>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Visitor</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-contain col-lg-4 fv-row">
                                            <label for="floatingPassword" class="required"><?= $this->lang->line('purpose');  ?></label>
                                            <select name="purpose" id="purpose" class="form-control form-control-lg form-control-solid" aria-label="Select example">
                                        ...
                                        <div class="input-contain col-sm-4 fv-row">
                                            ...
                                            <input type="text" id="contact" name="contact" autocomplete="off" value="" placeholder="0092...." class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                        </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('cnic');  ?></label>
                                        <input type="text" id="id_proof" name="id_proof" autocomplete="off" value="" placeholder="342342...." class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('in_time');  ?></label>

                                        <input type="time" id="in_time" name="in_time" autocomplete="off" value="" aria-labelledby="placeholder-name" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('out_time');  ?></label>
                                        <input type="time" id="time" name="out_time" autocomplete="off" value="" aria-labelledby="placeholder-name" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>

                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('number_of_person');  ?></label>
                                        <input type="text" id="pepples" name="pepples" autocomplete="off" value="" aria-labelledby="placeholder-name" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
...
// console.log(myDropzone);
    ...
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/visitors/add_visitor") ?>',
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    $('#purpose, #name, #contact, #id_proof, #kt_datepicker_2, #in_time, #time, #pepples, #email, #note').val("");
