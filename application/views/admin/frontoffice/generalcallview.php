    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Phone Call Log</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="javascript:" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Create Call Log</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                ...
                                                <th class="min-w-100px"><?php echo $this->lang->line('date'); ?></th>

                                                <th class="min-w-100px"><?php echo $this->lang->line('next_follow_up_date'); ?></th>


                                                <th class="min-w-100px"><?php echo $this->lang->line('call_type'); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Call Log</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <form id="kt_modal_add_reference_form" class="form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-contain col-sm-4 fv-row">
                                            ...
                                            <input type="text" id="contact" name="contact" autocomplete="off" value="" placeholder="<?= $this->lang->line('contact');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                        </div>

                                        <div class="input-contain col-sm-4 fv-row">
                                            <label for="floatingPassword"><?= $this->lang->line('description');  ?></label>
                                            <input type="text" id="description" name="description" autocomplete="off" value="" placeholder="<?= $this->lang->line('description');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                        </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        ...
                                        <input type="date" id="kt_datepicker_2001" name="follow_up_date" autocomplete="off" value="" placeholder="" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('call_duration');  ?></label>
                                        <input type="text" id="call_dureation" name="call_dureation" autocomplete="off" value="" placeholder="<?= $this->lang->line('call_duration');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('name');  ?></label>
                                        <input type="text" id="name" name="name" autocomplete="off" value="" placeholder="<?= $this->lang->line('name');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="input-contain col-sm-12 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('note');  ?></label>
                                        <input type="text" id="note" name="note" autocomplete="off" value="" placeholder="<?= $this->lang->line('note');  ?>" aria-labelledby="placeholder-name" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="d-flex flex-column fv-row">
                                        <!--begin::Radio-->
                                        <label for="floatingPassword" class="required" style="margin-bottom: 10px;font-weight: 800;font-size: 16px;"><?= $this->lang->line('call_type');  ?></label>
                                        <div class="form-check form-check-custom form-check-solid mb-5">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="call_type" type="radio" value="Incoming" id="kt_docs_formvalidation_radio_option_1" />
                                            <!--end::Input-->

                                            <!--begin::Label-->
                                            <label class="form-check-label" for="kt_docs_formvalidation_radio_option_1">
                                                <div class="fw-bolder text-gray-500">Incoming</div>
                                            </label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Radio-->
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-5">
                                            <!--begin::Input-->
                                            <input class="form-check-input me-3" name="call_type" type="radio" value="Outgoing" id="kt_docs_formvalidation_radio_option_2" />
                                            <!--end::Input-->

                                            <!--begin::Label-->
                                            <label class="form-check-label" for="kt_docs_formvalidation_radio_option_2">
                                                <div class="fw-bolder text-gray-500">Outgoing</div>
                                            </label>
...
<script>
    ...
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/generalcall/add_generalcall") ?>',
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    $("#name,#kt_datepicker_2,#kt_datepicker_2001, #contact, #date, #description, #call_dureation, #note, #call_type").val("");
