                                        ...
                                        foreach ($CallList as $key => $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right" style="float:right !important">
                                                    <a data-placement="left" onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs" data-target="#calldetails" data-toggle="modal"  title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-eye text-black"></i></a>   <?php if ($this->rbac->hasPrivilege('phone_call_log', 'can_edit')) { ?>
