                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="1"><?php echo set_value('description'); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right" style="float:right !important">
                                                    <a data-placement="left" onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs" data-target="#complaintdetails" title="<?php echo $this->lang->line('view') ?>" data-toggle="modal" data-original-title="<?php echo $this->lang->line('view') ?>"><i class="fa fa-eye text-black"></i></a>
    ...
    <div class="modal-dialog modal-dialog2 modal-lg">
        <div class="modal-content">
            <div class="modal-header themecolor">
                ...
                <h4 class="modal-title">Complaint <?php echo $this->lang->line('details'); ?></h4>
            </div>
