           ...
           <div class="col-md-9">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#clients" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('clients_list'); ?></a></li>
                        ...
                        if ($this->rbac->hasPrivilege('staff', 'can_edit')) {
                            ...
                            if($logged_in_User_Role->id == 7){
                               if ($a) {
                                ...
                                if($staff["admin_id"]==0 && $staff["staff_type"]=='admin'){
                                ?>
                                <li class="pull-right"><a href="<?php echo base_url('admin/adminprofile/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo "Edit"; ?>" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>
                                <?php }else{?>
                                <li class="pull-right"><a href="<?php echo base_url('admin/staff/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo "Edit"; ?>" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>
                                <?php
                                }
                                        ...
                                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                if (empty($adminuserlist)) {
                                                    ...
                                                    $count = 1;
                                                    foreach ($adminuserlist as $student) {
                                                        ?>
                                                        <tr>
                                                        
                                                            <td><?php echo $student['client_id']; ?></td>
                                                    
                                                            <td> 
                                                                <a href="<?php echo base_url(); ?>client/view/<?php echo $student['id']; ?>"><?php echo $student['firstname'] . " " . $student['lastname']; ?>
                                                                </a>
                                                            </td>
                                                            
                                                            <td><?php echo $student['gender']; ?></td>
                                                            <?php //if ($sch_setting->category) {  ?>
                                                            <td><?php  echo $student['category_name'];
                                                            ?></td>
                                                            <?php //} ?>
                                                            ...
                                                            <td class="pull-right">
                                                                <a href="<?php echo base_url(); ?>client/view/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                                    <i class="fa fa-reorder"></i>
                                                                </a>
                                                                <?php
                                                                if ($this->rbac->hasPrivilege('client', 'can_edit')) {
                                                                    ?>
                                                                    <a href="<?php echo base_url(); ?>client/edit/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    <div class="slide-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-6 col-md-6">
                                                                <address>
                                                                    <b><?php echo $this->lang->line('client_id'); ?>: </b><?php echo $student['client_id'] ?><br/>
                                                                    <b>
                                                                    <?php if($student['email']){?>
                                                                    <b><?php echo $this->lang->line('email'); ?>:&nbsp;</b><?php echo $student['email'] ?><br>
                                                                    <?php } ?>
                                                                    <?php if($student['cnic_no']){?>
                                                                    <b><?php echo $this->lang->line('cnic_no'); ?>:&nbsp;</b><?php echo $student['cnic_no'] ?><br>
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if($student['category_name']){?>
                                                                    <b><?php echo $this->lang->line('category'); ?>:&nbsp;</b><?php echo $student['category_name'];
                                                                    ?><br>
                                                                    <?php } ?>
                                                                    <?php if($student['religion']){?>    
                                                                    <b><?php echo $this->lang->line('religion'); ?>:&nbsp;</b><?php echo $student['religion'] ?><br>
                                                                    <?php } ?>
                                                                    
                                                                </address>
                                                            </div>
                                                            <div class="col-xs-6 col-md-6">
                                                                <?php if($student['current_address']!=''){?>    
                                                                <b><?php echo $this->lang->line('current_address'); ?>:&nbsp;</b><?php echo $student['current_address'] ?><br>
                                                                <?php } ?>
                                                                <?php if($student['permanent_address']!=''){?>    
                                                                <b><?php echo $this->lang->line('permanent_address'); ?>:&nbsp;</b><?php echo $student['permanent_address'] ?><br>
                                                                <?php } ?>

                                                                <?php if($student['cast']){?>    
                                                                <b><?php echo $this->lang->line('cast'); ?>:&nbsp;</b><?php echo $student['cast'] ?><br>
                                                                <?php } ?>
                                                                <?php if($student['mobileno']){?> 
                                                                <b><?php echo $this->lang->line('mobileno'); ?>: </b> <abbr title="Phone"><i class="fa fa-phone-square"></i>&nbsp;</abbr> <?php echo $student['mobileno'] ?><br>
                                                                <?php } ?>
                                                                <?php if($student['current_address']){?> 
                                                                    <b><?php echo $this->lang->line('current_address'); ?>:&nbsp;</b><?php echo $student['current_address'] ?> <br>
                                                                    <?php } ?>
                                                                    <?php if($student['country_name']){?> 
                                                                    <b><?php echo $this->lang->line('country_name'); ?>:&nbsp;</b><?php echo $student['country_name'] ?> <br>
                                                                    <?php } ?>
                                                                    <?php if($student['state_name']){?>
                                                                    <b><?php echo $this->lang->line('state_name'); ?>:&nbsp;</b><?php echo $student['state_name'] ?> <br>
                                                                    <?php } ?>
                                                                    <?php if($student['city_name']){?>
                                                                    <b><?php echo $this->lang->line('city_name'); ?>:&nbsp;</b><?php echo $student['city_name'] ?><br>
                                                                    <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
     ...
     $(document).ready(function (){
         $(document).on('click', '.printInv', function () {
          var id = $('#generate_paper_id').val();
            $.ajax({
                url: '<?php echo site_url("admin/staff/report") ?>',
                type: 'post',
                data: {'id': id},
