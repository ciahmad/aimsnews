    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="<?php echo base_url() . "uploads/staff_images/" . $image; ?>" alt="image" />
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1"><?php echo $staff['name'] . " " . $staff['surname']; ?></a>
                                        <a href="#">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <!--begin::Form-->
                <form action="<?php echo site_url('admin/adminprofile/edit/' . $staff["id"]) ?>"  id="kt_account_profile_details_form" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data" class="form">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" >
                                    <?php
                                        if ($staff['image'] == "") {
                                            $staff_img ='uploads/staff_images/images.png';
                                            ?>
                                            <?php
                                        } else {
                                            $staff_img ='uploads/staff_images/'.$staff['image'];
                                            ?>
                                            <?php
                                        }
                                        ?>
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px">
                                        <img src="<?php echo base_url().$staff_img; ?>" class="img-responsive img-thumbnail" width="200" height="100"> 
                                    </div>
                                    <!--begin::Preview existing avatar-->
                                    <!-- <div class="image-input-wrapper w-125px h-125px" style="background-image: url('<?php echo base_url(); ?>assets/media/svg/avatars/blank.svg')">
                                        <img src="<?php echo base_url().$staff_img; ?>" class="img-responsive img-thumbnail" width="200" height="100"> 
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="account_no" name="account_no" autocomplete="off" value="<?php echo set_value('account_no', $staff['account_no']) ?>" aria-labelledby="placeholder-account_no" class="form-control form-control-lg form-control-solid" readonly style="background-color: #ccc;">
                                        <label class="placeholder-text" for="account_no" id="placeholder-account_no">
                                            <div class="text"><?php echo $this->lang->line('account_no'); ?></div>
                                        </label>
                                    </div>
                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="fname" name="fname" autocomplete="off" value="<?php echo set_value('name',$staff['name']) ?>" aria-labelledby="placeholder-fname" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="fname" id="placeholder-fname">
                                            <div class="text"><?php echo $this->lang->line('first_name'); ?></div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="lname" name="lname" autocomplete="off" value="<?php echo set_value('surname',$staff['surname']) ?>" aria-labelledby="placeholder-lname" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="lname" id="placeholder-lname">
                                            <div class="text"><?php echo $this->lang->line('last_name'); ?></div>
                                        </label>
                                    </div>
                                    <!--end::Col-->
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="father_name" name="father_name" autocomplete="off" value="<?php echo set_value('father_name',$staff['father_name']) ?>" aria-labelledby="placeholder-father_name" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="father_name" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('father_name'); ?></div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">

                                        <select name="gender" id="gender" class="form-control form-control-lg form-control-solid" aria-label="Select example">
                                        ...
                                        <label class="placeholder-text" for="gender" id="placeholder-gender"><div class="text"><?php echo $this->lang->line('gender'); ?></div>
                                        </label> 
                                    </div>
                                    <div class="input-contain col-lg-4 fv-row">

                                        <div class="mb-0">
                                            <input class="form-control form-control-lg form-control-solid" placeholder="" id="kt_datepicker_1" name="dob" autocomplete="off" value="<?php if (!empty($staff["dob"])) { echo date($this->customlib->getSchoolDateFormat(), strtotime($staff["dob"])); }?>"/>
                                        </div>
                                        <label class="placeholder-text" for="dob" id="placeholder-dob">
                                            <div class="text"><?php echo $this->lang->line('date_of_birth'); ?></div>
                                        </label>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-4 fv-row">
                                        ...
                                        <select name="marital_status" id="marital_status" class="form-control form-control-lg form-control-solid" aria-label="Select example">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        ...
                                        <label class="placeholder-text" for="marital_status" id="placeholder-marital_status"><div class="text"><?php echo $this->lang->line('marital_status'); ?></div>
                                        </label> 
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="contactno" name="contactno" autocomplete="off" value="<?php echo set_value('contactno', $staff["contact_no"]); ?>" aria-labelledby="placeholder-contactno" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="contactno" id="placeholder-contactno">
                                            <div class="text"><?php echo $this->lang->line('contactno'); ?></div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="emergency_no" name="emergency_no" autocomplete="off" value="<?php echo set_value('emergency_no', $staff["emergency_contact_no"]); ?>" aria-labelledby="placeholder-emergency_no" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="emergency_no" id="placeholder-emergency_no">
                                            <div class="text"><?php echo $this->lang->line('emergency_contact_number'); ?></div>
                                        </label>
                                    </div>
                                    <!--end::Col-->
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <!--begin::Col-->
                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="email" name="email" autocomplete="off" value="<?php echo set_value('email',$staff['email']) ?>" aria-labelledby="placeholder-email" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="email" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('email'); ?> (<?php echo $this->lang->line('login') . " " . $this->lang->line('username'); ?>) </div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="cnic_no" name="cnic_no" autocomplete="off" value="<?php echo set_value('cnic_no', $staff["cnic_no"]); ?>" aria-labelledby="placeholder-cnic_no" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="cnic_no" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('cnic_no'); ?></div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-4 fv-row">
                                        <input type="text" id="qualification" name="qualification" autocomplete="off" value="<?php echo set_value('qualification', $staff["qualification"]); ?>" aria-labelledby="placeholder-qualification" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="qualification" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('qualification'); ?></div>
                                        </label>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-lg-6 fv-row">
                                        <input type="text" id="current_address" name="current_address" autocomplete="off" value="<?php echo set_value('current_address', $staff["current_address"]); ?>" aria-labelledby="placeholder-current_address" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="current_address" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('current'); ?> <?php echo $this->lang->line('address'); ?></div>
                                        </label>
                                    </div>

                                    <div class="input-contain col-lg-6 fv-row">
                                        <input type="text" id="permanent_address" name="permanent_address" autocomplete="off" value="<?php echo set_value('permanent_address', $staff["permanent_address"]); ?>" aria-labelledby="placeholder-permanent_address" class="form-control form-control-lg form-control-solid">
                                        <label class="placeholder-text" for="permanent_address" id="placeholder-father_name">
                                            <div class="text"><?php echo $this->lang->line('permanent_address'); ?></div>
                                        </label>
                                    </div>
                                    <!--end::Col-->
                                </div>
