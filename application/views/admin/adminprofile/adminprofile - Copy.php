            ...
            <aside class="studentsidebar">
                <div class="stutop" id="">
                    ...
                    <div class="tab-content">
                        <input type="hidden" name="generate_paper_id" id="generate_paper_id" value=" <?php echo $staff['id'] ?> ">
    ...
    <section class="content">
        <div class="row">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('staff_id'); ?></b> <a class="pull-right text-aqua"><?php echo $staff['account_no']; ?></a>
                            </li>

                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('institute_name'); ?></b> <a class="pull-right text-aqua"><?php echo $staff['school_name']; ?></a>
                            </li>
						
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('role'); ?></b> <a class="pull-right text-aqua"><?php echo $staff['designation']; ?></a>
                            </li>
            ...
            <?php 
                ...
                //echo "<pre>"; echo $staff['id'].'='.$logged_in_User['id'].','.$logged_in_User_Role->id; "</pre>";
            ?>
           <div class="col-md-9">
                ...
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#subscription" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('subscription'); ?></a></li>
                        <li class=""><a href="#staff" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('staff'); ?></a></li>
                        ...
                        <?php if ($staff['id']!= $logged_in_User['id'] && $logged_in_User_Role->id==7){ ?>
                        <li class=""><a href="#assign_modules" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('assign_modules'); ?></a></li>
                        <?php } ?>
                        ...
                        ?>
                        <div class="newdropdown pull-right">
                            <button class="newdropbtn themecolor">Action &nbsp;<i class="fa fa-arrow-down"></i></button>
                            ...
                            if ($staff["is_active"] == 1) {
                                if ($this->rbac->hasPrivilege('disable_staff', 'can_view')) {
                                    if($logged_in_User_Role->id == 7){
                                        if ($a) { ?> 
                                            <li class="pull-right">
                                        <a  class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('disable'); ?>" onclick="disable_staff('<?php echo $id; ?>');"></i> <i class="fa fa-thumbs-o-down"></i></a></li>
                                        <?php }
                                    }else{ ?> 
                                        <li class="pull-right">
                                        <a href="<?php echo base_url('admin/staff/disablestaff/' . $id); ?>" class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('disable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_disable_record');?>')"></i> <i class="fa fa-thumbs-o-down"></i></a></li>
                                ...
                                if($logged_in_User_Role->id == 7){
                                    if ($a) { ?>
                                        <li class="pull-right">
                                    <a href="<?php echo base_url('admin/adminprofile/delete/' . $id); ?>" class="text-red" data-toggle="tooltip" data-placement="bottom"  title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure_delete_record'); ?>');"></i><i class="fa fa-trash"></i></a></li>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/adminprofile/enablestaff/' . $id); ?>" class="text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('enable'); ?>" onclick="return confirm('<?php echo $this->lang->line('are_you_sure').' '.$this->lang->line('you_want_to_enable_this_record'); ?>');"><i class="fa fa-thumbs-o-up"></i></a> </li> 
                                    <?php }
                                }else{
                        ...
                        <?php if ($a) { ?>
                            <li class="pull-right">
                            <a href="javascript:" class="change_password text-green" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('change_password'); ?>" ></i> <i class="fa fa-key"></i></a></li>
                        <?php  } ?>
                        ...
                        <?php if ($this->rbac->hasPrivilege('staff', 'can_edit')) { ?>
                            ...
                            <?php if($logged_in_User_Role->id == 7){
                                if ($a) { ?>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/adminprofile/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/roles/'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('roles_permissions'); ?>" class="text-light" ><img style="width:14px" src="<?php echo base_url('backend/images/'); ?>user-lock-solid.svg">&nbsp;</a></li>
                                <?php } ?>
                            <?php }else{ ?>
                                <?php if($staff["admin_id"]==0 && $staff["staff_type"]=='admin'){ ?>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/adminprofile/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/roles/'); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('roles_permissions'); ?>" class="text-light" ><img style="width:14px" src="<?php echo base_url('backend/images/'); ?>user-lock-solid.svg">&nbsp;</a></li>
                                ...
                                <?php }else{?>
                                    <li class="pull-right">
                                    <a href="<?php echo base_url('admin/staff/edit/' . $id); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $this->lang->line('edit'); ?>" class="text-light" ><i class="fa fa-pencil"></i></a></li>
                                <?php }?>
                            <?php } ?>
                    ...
                    <div class="tab-content">
                        <?php if ($staff['id']!= $logged_in_User['id'] && $logged_in_User_Role->id==7){ ?>
                        <div class="tab-pane" id="assign_modules">
                            <div class="timeline-header no-border">
                                <div class="row">
                                    <form action="<?php echo site_url('admin/adminprofile/assignemodule/'. $staff["id"]) ?>"  id="assigneModule" name="assigneModule" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        <div class="form-group">

                                            <label class="col-sm-3 control-label">Assigne Module Permission</label>
                                            <div class="col-sm-8">
                                                <div class="well well-sm" style="height: 350px; overflow: auto;">
                                                    <?php foreach ($permissions as $key => $module) { 

                                                        $isexist = $this->adminprofile_model->getAssignedModules($module['id'], $id);
                                                        ?>
                                                        <div class="checkbox">
                                                          <label>
                                                            <?php if($isexist){?>
                                                            <input type="checkbox" name="module_name[]" value="<?php echo $module['id'].','.$module['name'].','.$module['short_code']?>" checked />
                                                            <?php echo $module['name']?>
                                                        <?php }else{?>
                                                            <input type="checkbox" name="module_name[]" value="<?php echo $module['id'].','.$module['name'].','.$module['short_code']?>" />
                                                            <?php echo $module['name']?>
                                                        <?php }?>
                                                          </label>
                                                        </div>
                                                ...
                                                <button type="button" onclick="$(this).parent().find(':checkbox').prop('checked', true);" class="btn btn-link"><?php echo $this->lang->line('text_select_all'); ?></button> / <button type="button" onclick="$(this).parent().find(':checkbox').prop('checked', false);" class="btn btn-link"><?php echo $this->lang->line('text_unselect_all'); ?></button>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <div class="col-sm-11">
                        ...
                        <div class="tab-pane active" id="activity">
                            ...
                            <div class="tshadow mb25  bozero">    
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo base_url() . "admin/staff/report/" . $id ?> " title="Generate Profile report">
                                    <button type="" class="btn btn-sm btn-secondary">Generate Report</button>
                                </a> 
                                </div>
                            </div> 
							<?php } ?>
                        ...
                        <div class="tab-pane" id="subscription">
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="staffprofile" style="height:90px">

                                        <h4><?php echo $this->lang->line('package_name'); ?>: <?php echo $activepackages['package_name']; ?></h4>
                                        <h5><span class="pull-left" ><?php echo $this->lang->line('start_date'); ?>: <?php echo $activepackages['start_date']; ?></span> 
                                            <span class="pull-right" ><?php echo $this->lang->line('end_date'); ?>: <?php echo $activepackages['end_date']; ?></span>
                                        </h5> 
                                    ...
                                    <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            if (empty($subscriptionlist)) {
                                                ...
                                                $count = 1;
                                                foreach ($subscriptionlist as $subscripton) {
                                                    ?>
                                                    <tr>
                                                        ...
                                                        <td class="pull-right">
                                                            <button id="btnstatus<?php echo $subscripton['id']; ?>" class="btn btn-info btn-xs change_status badge bg-blue" data-status="<?php echo $subscripton['status']; ?>" data-trans_id="<?php echo $subscripton['payment_transaction_id']; ?>" data-id="<?php echo $subscripton['id'] ?>"><?php echo $this->lang->line('status'); ?>
                                                            </button>
                        ...
                        <div class="tab-pane" id="staff">
                            <div class="nav-tabs-custom border0 navnoshadow">
                                ...
                                <li class="active"><a href="#tab_4" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('card'); ?> <?php echo $this->lang->line('view'); ?></a></li>
                                <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line('list'); ?>  <?php echo $this->lang->line('view'); ?></a></li>
                                </ul>
                                <div class="tab-content">  
                                    <div class="download_label"><?php echo $this->lang->line('details_for'); ?> <?php echo $staff["name"] . " " . $staff["surname"]; ?></div>  
                                    <div class="tab-pane table-responsive no-padding" id="tab_3">
                                        <table class="table table-hover table-striped example" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                if (empty($adminstafflist)) {
                                                    
                                                } else {
                                                    $count = 1;
                                                    foreach ($adminstafflist as $staff) {
                                                        ?>
                                                        <tr>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-6 img_div_modal">
                                                            <div class="staffinfo-box">
                                                                ...
                                                                <div class="staffleft-content">
                                                                    ...
                                                                    <p><font data-toggle="tooltip" title="<?php echo "Employee Id"; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $staff["account_no"] ?></font></p>
                         ...
                         <div class="modal-body pt0 pb0">   
                            ...
                            <div class="modal-footer" style="clear:both">
                               <!--  <button type="button" class="btn btn-default pull-left" data-dismiss="modal"><?php //echo $this->lang->line('cancel'); ?></button> -->
                                ...
                                <button type="reset" id="reset" style="display: none"  class="btn btn-info pull-right themecolor">Reset</button>                            
                            </div>
                        </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" id="changepassbtn" action="">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary themecolor"><?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        $("#disablebtn").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({ 
                url: "<?php echo site_url('admin/adminprofile/disablestaff/') ?>" + staff_id,
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
     ...
     $(document).ready(function (e) {
        $("#changepassbtn").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url('admin/adminprofile/change_password/') ?>" + staff_id,
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
...
<script>
    ...
    function ajax_attendance(id, year) {
        ...
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/adminprofile/ajax_attendance/' + id,
            type: 'POST',
...
<script type="text/javascript">
     $(document).ready(function (){
         $(document).on('click', '.printInv', function () {
          var id = $('#generate_paper_id').val();
            $.ajax({
                url: '<?php echo site_url("admin/adminprofile/report") ?>',
                type: 'post',
                data: {'id': id},
