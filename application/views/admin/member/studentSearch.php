        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('admin/member/add') ?>" id="add_member" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm add-member themecolor" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><?php echo $this->lang->line('add'); ?></button>
                </form>
