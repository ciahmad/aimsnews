...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-usd"></i> <?php echo $this->lang->line('payment_voucher'); ?></h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            ...
            <?php if ($this->rbac->hasPrivilege('paymentvoucher', 'can_add')) {?>
                <?php $this->load->view('admin/income/_sidemenu');?>
                <div class="col-md-10">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><?php echo $this->lang->line('payment_voucher'); ?></h3>
                        </div><!-- /.box-header -->
                        <form action="<?php echo base_url() ?>admin/paymentvoucher"  id="pvform" name="pvform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-sm-6"></div>
                                    <div class="col-md-2 col-sm-2">
                                        <label for="pv_number"><?php echo $this->lang->line('pv_number'); ?></label>
                                    </div>
                                    <div class="form-group col-md-4">
                                            ...
                                            <div class="table-responsive mailbox-messages">
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-info pull-right colorbtn" id="add_more" data-id="<?php echo $i;?>" onclick="addMore()">+</button>
                                                            </td>
                                                            <?php $i++ ;} ?>
                                ...
                                <div class="box-footer">
                                    <button type="submit" id="submitpv" class="btn btn-info pull-right colorbtn"><?php echo $this->lang->line('save'); ?></button>
                                </div>
