                    ...
                    <div class="box-header ptbnull themecolor">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('apply_leave', 'can_add')) { ?>
                                <small class="pull-right"><a href="#addleave" onclick="addLeave()" role="button" class="btn btn-sm checkbox-toggle pull-right edit_setting themecolor" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $this->lang->line('apply_leave'); ?></a></small>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    ...
                                    <?php echo $this->lang->line('leaves'); ?>
                                    </div>
                                </div>
                            </div>
                                    <!-- <div class="download_label">
                ...
                <div class="row">
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <button type="submit" class="btn themecolor submit_addLeave pull-right" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $this->lang->line('save'); ?></button>
