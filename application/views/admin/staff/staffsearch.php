            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('staff'); ?> Search</h3>
                        <div class="box-tools pull-right">
                            <small class="pull-right">
                                <?php if ($this->rbac->hasPrivilege('staff', 'can_add')) { ?> <a href="<?php echo base_url(); ?>admin/staff/create" class="btn btn-primary btn-sm themecolor"   >
                        <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_staff'); ?>
                            </a><?php } ?>
                        </small>
                       </div>
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 img_div_modal">
                                                <div class="staffinfo-box">
                                                    ...
                                                    <div class="staffleft-content">
                                                        <h5 style="overflow: hidden; height:32px"><span data-toggle="tooltip" title="<?php echo $this->lang->line('name'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $staff["name"] . " " . $staff["surname"]; ?></span></h5>
