                        ...
                        <div class="box-body">
                            ...
                            <div class="tshadow mb25 bozero">    
                                ...
                                <div class="around10">
                                        ...
                                        <?php if ($sch_setting->staff_designation) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select onchange="getDesig()" id="designation" name="designation" class="form-control">
                                    ...
                                    <?php if ($shares_id!='') { ?>
                                    <div class="row" id="percent_of_shares" style="display: none;">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('percentage_of_shares'); ?> </label>

                                                <select id="percentage_of_shares" name="percentage_of_shares" placeholder="" type="text" class="form-control" >
                                                    <option value="select"><?php echo $this->lang->line('select') ?></option>
                                                    <?php foreach ($shares as $key => $share) {
                                                            if(is_numeric($share["value"])){
                                                        ?>
                                                        <option value="<?php echo $share["value"].'%' ?> " <?php
                                                            if ($staff["percentage_of_shares"] == $share["value"]) {
                                                                echo "selected";
                                                            }
                                                            ?> ><?php echo $share["value"].'%' ?></option>
                                                    <?php } }
                                                    ?>
                                                </select>
                                                <span class="text-danger"><?php echo form_error('designation'); ?></span>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var shares_id = '<?php echo $shares_id;?>';
        if(shares_id!=''){
