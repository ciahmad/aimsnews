...
<div class="content-wrapper">
            ...
            <div class="col-md-3">                
                ...
                ?>>
                    <div class="box-body box-profile">
                        ...
                        <?php
                                                 $filename = 'temp/'.$staff['employee_id'].'.png';
    ...
    if (isset($_REQUEST['size']))
        $matrixPointSize = min(max((int)$_REQUEST['size'], 1), 10);
                                       ...
                                       //default data  
        QRcode::png('Teacher - '. $staff['name'] . " " . $staff['surname'], $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
        
        
        $link = "http://".$_SERVER['HTTP_HOST']."/";
 echo '<img src="'.$link.$PNG_WEB_DIR.basename($filename).'" style="text-align:center !important;"  />'; 
                                                ?></h3>
                ...
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <?php } ?>
                        ...
                        if($staff['id'] == $logged_in_User['id']){
                            $a = true;
                        }elseif ( ($logged_in_User_Role->id == 7 && $logged_in_User_Role->name == "Super Admin") || ($logged_in_User_Role->id == 1 && $logged_in_User_Role->name == "Admin")){
                            if($staff["role_id"] == 7){
