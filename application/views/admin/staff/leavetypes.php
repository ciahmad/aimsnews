                        ...
                        <form id="form1" action="<?php echo site_url('admin/leavetypes/createLeaveType') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="admin_id"  name="admin_id" placeholder="" type="hidden" class="form-control"  value="<?php echo $admin_id; ?>" />
                                </div>
                                <!--div class="form-group">
                    ...
                    <div class="box-body">
                        ...
                        <div class="download_label">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    ...
                                    <?php echo $this->lang->line('leave_type') . " " . $this->lang->line('list'); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="download_label">
                                ...
                                <tbody>
                                    ...
                                    foreach ($leavetype as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name" style=""> <?php echo $value['type'] ?></td>
