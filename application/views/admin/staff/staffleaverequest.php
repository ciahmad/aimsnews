            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull themecolor">
                      ...
                      //  if ($this->rbac->hasPrivilege('approve_leave_request', 'can_add')) {
                            ?>
                            <small class="pull-right"><a href="#addleave" onclick="addLeave()" role="button" class="btn btn-sm checkbox-toggle pull-right edit_setting themecolor" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('leave_request'); ?></a></small>
                        <?php //} ?>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                                            ...
                                            foreach ($leave_request as $key => $value) {
                                                ...
                                                <tr>   
                                                    ...
                                                    <td class="pull-right no-print">
                                                        <a data-placement="left" href="#leavedetails" onclick="getRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" ><i class="fa fa-eye text-black"></i></a>

                                                        <?php if ($value["applied_by"] == $this->customlib->getAdminSessionUserName()) { ?>
                                                            <?php
                                                            if ($this->rbac->hasPrivilege('approve_leave_request', 'can_edit')) {
                                                                ?> 
                                                                <a data-placement="left" href="#addleave" onclick="editRecord('<?php echo $value["id"] ?>')" role="button" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>" ><i class="fa fa-edit text-green"></i></a>
                                                            <?php } ?>
                                                        ...
                                                        <?php if ($value["applied_by"] == $this->customlib->getAdminSessionUserName()) { ?>
                                                            ...
                                                            <a onclick="getDelete('<?php echo $value["id"] ?>')"  class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" ><i class="fa fa-trash text-danger"></i></a>
                            ...
                            <table class="table mb0 table-striped table-bordered examples">
                                ...
                                <tr>
                                    ...
                                    if ($this->rbac->hasPrivilege('approve_leave_request', 'can_edit')) {
                                        ?> 
                                        <td colspan="4">
                                            <button type="button" style="width: auto;"  class="btn submit_schsetting pull-right themecolor" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $this->lang->line('save'); ?></button>
                                        </td>
                                    <?php } ?>
                                </tr>
                            </table>
                ...
                <div class="row">
                    <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <button type="submit" class="btn submit_addLeave pull-right themecolor" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> <?php echo $this->lang->line('save'); ?></button>
