                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-6 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('room_type');  ?></label>
                                        <input type="text" id="room_type" name="room_type" autocomplete="off" value="" placeholder="<?= $this->lang->line('room_type');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-6 fv-row">
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/roomtype/create") ?>',
            type: 'POST',
