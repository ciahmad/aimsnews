            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header with-border aimsreportsbg">
                        <h3 class="box-title"><i class="fa fa-search"></i> Balance Fee Report<?php //echo $this->lang->line('select_criteria'); ?></h3>
                    </div>
                    <form action="<?php echo site_url('admin/transaction/studentacademicreport') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm pull-right themecolor"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>   </div>
                    </form>
