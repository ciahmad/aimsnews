            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php  } ?>
                        <li style="padding: 2px; text-align: center;" class="garnishbg" class="<?php echo set_Submenu('Reports/inventory'); ?>"><a style="color:white;" href="<?php echo base_url(); ?>report/inventory"><?php echo $this->lang->line('inventory') . ' ' . $this->lang->line('reports'); ?></a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-10">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/issueitem/add') ?>" id="issueitem" name="employeeform" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="allot-fees btn btn-primary btn-sm pull-right themecolor" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><?php echo $this->lang->line('submit'); ?>
                            </button>
                        </div>
                    </form>
                </div>
