            ...
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php  } ?>
                        <!-- <li class="<?php echo set_Submenu('Reports/inventory'); ?>"><a  href="<?php echo base_url(); ?>report/inventory"><?php echo $this->lang->line('inventory') . ' ' . $this->lang->line('reports'); ?></a></li>   -->

                        <li><a href="<?php echo base_url(); ?>report/inventory"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('inventory'); ?> <?php echo $this->lang->line('reports'); ?></a></li>
                    ...
                    <div class="box-header with-border themecolor">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('issue_item', 'can_add')) { ?>
                                <a href="<?php echo site_url('admin/issueitem/create') ?>" type="button" class="btn btn-primary btn-sm themecolor"><i class="fa fa-plus"></i> <?php echo $this->lang->line('issue_item'); ?></a>
                            <?php }
                            ?>
