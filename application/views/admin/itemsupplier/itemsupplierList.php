    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?= $this->lang->line('item_supplier') ?></h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Item Supplier</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px"><?= $this->lang->line('item_supplier'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('contact_person'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('address'); ?></th>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-name">
                                                            ...
                                                            <a href="javascript:" data-toggle="popover" class="detail_popover">
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Item Supplier</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        ...
                                        <input type="text" id="phone" name="phone" autocomplete="off" value="" placeholder="<?= $this->lang->line('phone');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>

                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('email');  ?></label>
                                        <input type="email" id="email" name="email" autocomplete="off" value="" placeholder="<?= $this->lang->line('email');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('address');  ?></label>
                                        <input type="text" id="address" name="address" autocomplete="off" value="" placeholder="<?= $this->lang->line('address');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('contact_person_name');  ?></label>
                                        <input type="text" id="contact_person_name" name="contact_person_name" autocomplete="off" value="" placeholder="<?= $this->lang->line('contact_person_name');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>

                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('contact_person_phone');  ?></label>
                                        <input type="text" id="contact_person_phone" name="contact_person_phone" autocomplete="off" value="" placeholder="<?= $this->lang->line('contact_person_phone');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-6 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('contact_person_email');  ?></label>
                                        <input type="email" id="contact_person_email" name="contact_person_email" autocomplete="off" value="" placeholder="<?= $this->lang->line('contact_person_email');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/itemsupplier/create") ?>',
            type: 'POST',
