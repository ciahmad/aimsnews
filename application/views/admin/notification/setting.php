        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('notification_setting'); ?></h3>
                        <div class="box-tools pull-right ">
                            <small class="pull-right ">
                                <?php if ($this->rbac->hasPrivilege('notification_setting', 'can_add')) { ?> 
                                    <a href="<?php echo base_url(); ?>admin/notification/create" class="btn btn-primary btn-sm colorbtn"><i class="fa fa-plus"></i> <?php echo $this->lang->line('create_setting'); ?>
                                    </a>
                                <?php } ?>
                        </small>
                       </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($notificationlist as $note_key => $note_value) {
                                            //echo "<pre>"; print_r($note_value); "</pre>"; 
                                            $hr = "";
                                            if ($i != $last_key) {
                                                $hr = "<hr>";
                                            }
