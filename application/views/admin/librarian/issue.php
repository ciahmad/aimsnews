            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            <div class="col-md-6"> <h3 class="box-title"><?php echo $this->lang->line('issue_book'); ?></h3></div>
                            <div class="col-md-6">
                            <a style="padding-left: 21px; color:white; border:none; margin-right: 8px; float:right" class="" href="<?php echo base_url('admin/member');?>"><i style="color:white" class="fa fa-backward"></i>Back</a>
                            </div>
                        </div>                       
                    </div><!-- /.box-header -->
                    <!-- form start -->
