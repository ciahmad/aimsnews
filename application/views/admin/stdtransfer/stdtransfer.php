                ...
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/stdtransfer/index') ?>"  method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary btn-sm pull-right themecolor"><?php echo $this->lang->line('array_search(needle, haystack)'); ?><?php echo $this->lang->line('search'); ?></button>
                        </div>
                    </form>
                    ...
                    if (isset($resultlist)) {
                        ...
                        <div class="box-footer clearfix" >
                            ...
                            if (!empty($resultlist)) {
                                ...
                                <a class="btn btn-sm btn-primary pull-right themecolor" data-toggle="modal" data-target="#pramoteStudentModal"><?php echo $this->lang->line('promote'); ?></a>
                                <?php
                            }
                            ?>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary pramote_student themecolor"><?php echo $this->lang->line('save'); ?></button>
            </div>
        </div>
    </div>
</div>
