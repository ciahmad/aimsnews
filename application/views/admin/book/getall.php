        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="box box-primary" id="bklist">
                    <div class="box-header ptbnull themecolor" style="padding:0px">
                        <h3 style="line-height: 2;padding-left: 10px;" class="box-title titlefix"><?php echo $this->lang->line('book_list'); ?></h3><div class="pull-right">
                            <?php if ($this->rbac->hasPrivilege('books', 'can_add')) {
                                ?>
                                <a href="<?php echo base_url() ?>admin/book">
                                    <button class="btn-sm themecolor" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add') . " " . $this->lang->line('book'); ?></button>
                                </a>
                            <?php }
                            ?>
