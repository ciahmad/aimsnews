                ...
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('import_book', 'can_view')) {
                                ?>
                                <a class="btn btn-sm btn-primary themecolor" href="<?php echo base_url(); ?>admin/book/import" autocomplete="off"><i class="fa fa-plus"></i> <?php echo $this->lang->line('import') . " " . $this->lang->line('book'); ?></a> 
                            <?php }
                            ?>
                    ...
                    <form id="form1" action="<?php echo site_url('admin/book/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        ...
                        <div class="box-footer">
                            ...
                            <a style="padding-left: 21px; border:none; margin-right: 8px;" class="" style="float: left; border:none" href="<?php echo base_url('admin/book/getall');?>"><i class="fa fa-backward"></i>Back</a>
                        </div>
                    </form>
                </div>
