            ...
            <div class="col-md-2">
                <div class="box border0">
                    ...
                    <?php if ($this->rbac->hasPrivilege('routes', 'can_view')) { ?>
                                ...
                                <li class="<?php echo set_Submenu('reports/studenttransportdetails'); ?>"><a href="<?php echo base_url(); ?>admin/route/studenttransportdetails"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('transport'); ?> <?php echo $this->lang->line('reports'); ?></a></li>
