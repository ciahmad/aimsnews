...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-2">
                <div class="box border0">
                    ...
                    <?php if ($this->rbac->hasPrivilege('routes', 'can_view')) { ?>
                                ...
                                <li class="garnishbg"><a style="color:white" href="<?php echo base_url(); ?>admin/route/studenttransportdetails"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('transport'); ?> <?php echo $this->lang->line('reports'); ?></a></li>                                     
                    </ul>
                </div>
            </div>
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('student_transport_report'); ?></h3>
                    </div>
            ...
            <div class="col-md-12">
                        <div class="box-header ptbnull garnishbg">
