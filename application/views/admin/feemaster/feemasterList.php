                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><?php echo $this->lang->line('add_fees_master') . " : " . $this->setting_model->getCurrentSessionName($admin_id); ?></h3>
                        </div>
                                ...
                                <div class="row">
                                    <div id="fm0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus="" id="fee_groups_id" name="fee_groups_id" class="form-control" >
                                                    ...
                                                    foreach ($feegroupList as $feegroup) { ?>
                                                        <option value="<?php echo $feegroup['id'] ?>"><?php echo $feegroup['name'] ?></option>
                                                    <?php
                                                        $count++;
                                                        }
                                                    ?>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="pull-right themecolor" id="add_more" data-id="0" onclick="addMore()">Add+</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Fee Payment Type</label>
                                            <select name="fee_payment_type" class="form-control">
                                                <option value="1">One Time</option>
                                                 <option value="2">Re-Curring</option>
                                            </select>
                                        </div>
                                    </div> --> 
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <select id="month_name" name="month_name" class="form-control" >
                                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                <?php foreach ($num_of_months as $month) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="date" name="due_date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date'); ?>" readonly="readonly" />
                                            <span class="text-danger"><?php echo form_error('date'); ?></span>
                                        </div> -->

                                        <!-- <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('due_date'); ?></label>
                                            <input id="date" name="due_date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('due_date'); ?>" readonly="readonly"/>
                                    ...
                                    <input name="account_type" class="finetype" id="input-type-tutor" value="fix" type="hidden"  <?php echo set_radio('account_type', 'fix', set_value('fix')); ?> />
                                    <input name="account_type" class="finetype" id="input-type-student" value="percentage" type="hidden" <?php echo set_radio('account_type', 'percentage', set_value('percentage')); ?> />
                                    <input name="account_type" class="finetype" id="input-type-student" value="none" type="hidden" <?php echo set_radio('account_type', 'none', true); ?>/>
                                    <input id="fine_percentage" name="fine_percentage" placeholder="" type="hidden" class="form-control"  value="<?php echo set_value('fine_percentage'); ?>" />
                                    <input id="fine_amount" name="fine_amount" placeholder="" type="hidden" class="form-control"  value="<?php echo set_value('fine_amount'); ?>" />
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull themecolor">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('fees_master_list') . " : " . $this->setting_model->getCurrentSessionName($admin_id); ?></h3>

                    </div>

                    <div class="box-body">
                        <div class="download_label"><?php echo $this->lang->line('fees_master_list') . " : " . $this->setting_model->getCurrentSessionName($admin_id); ?></div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name">
                                                    <ul class="liststyle1">
                                                        ...
                                                        foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                            ?>
                                                            <li style="line-height: 25px"> <?php  echo $feetype_value->code; ?> &nbsp;&nbsp; </li> <?php
                                                        }
                                                        ?>
                                                    </ul>
                                                </td>
                                                ...
                                                <td class="mailbox-name">
                                                    <ul class="liststyle1">
                                                        ...
                                                        foreach ($feegroup->feetypes as $feetype_key => $feetype_value) {
                                                            ?>
                                                            <li style="line-height: 25px"> <?php echo $feetype_value->amount; ?> &nbsp;&nbsp;</li>
                                                            <?php
                                                        }
                                                        ?>
                                                    </ul>
