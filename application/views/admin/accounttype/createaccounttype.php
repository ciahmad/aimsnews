        ...
        <div class="row">
                    ...
                    <form id="form1" action="<?php echo site_url($posturl) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body row">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus=""  id="account_number" name="account_number" placeholder="" type="text" class="form-control"  value="<?php echo $editaccount['account_number']; ?>" />
            ...
            ?>">
                ...
                <div class="box box-primary" id="exphead">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            <div class="col-md-6"><h3 class="box-title">Accounts Types</h3></div>
