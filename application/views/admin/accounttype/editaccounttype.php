...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('accounttype', 'can_edit')) { ?>
            <div class="col-md-4">
                <!-- Horizontal Form -->
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/accounttype/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="parent_account_type_id" name="parent_account_type_id" class="form-control" style="<?php echo $style;?>">
                                    ...
                                    <?php
                                        foreach ($listaccounts as $listaccount) {
                                            ...
                                            ?>
                                            <option style="color: #000;font-weight: 600;" value="<?php echo $listaccount['id']; ?>" <?php echo set_select('id', $key, set_value('id')); ?> <?php echo $selected;?> ><?php echo $listaccount['name']; ?> - <?php echo $listaccount['account_number']; ?></option>
                                            <?php foreach ($listaccount['children'] as $child) {
                                                if ($editaccount['id']==$child['id']) {
                                                    $selected = 'selected';
                                                }else{ $selected = ''; }
                                             ?>
                                            <option value="<?php echo $child['id']; ?>" <?php echo set_select('id', $key, set_value('id')); ?> <?php echo $selected;?>><?php echo $child['name']; ?> - <?php echo $child['account_number']; ?></option>
                                            <?php }?>
                                            <?php
                                        }}
                                    ?>
                                    ...
                                    <?php
                                        ...
                                        foreach ($listaccounts as $listaccount) {
                                            ...
                                            <tr>    
                                                ...
                                                <th><?php echo $listaccount['account_number'] ?></th>
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('accounttype', 'can_delete')) {
                                                        ?>
                                            ...
                                            <tr>                                             
                                                ...
                                                <td><?php echo $child['account_number'] ?></td>
                                                <td class="mailbox-date pull-right no-print">
                                                    <?php
