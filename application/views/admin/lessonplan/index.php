    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header themecolor">
                <h3 class="box-title"><i class="fa fa-search"></i>  Manage Syllabus Status<?php //echo $this->lang->line(''); ?></h3>
            </div>
            ...
            <form class="assign_teacher_form" action="<?php echo base_url(); ?>admin/syllabus/status" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <button type="submit" id="search_filter" name="search" value="search_filter" class="btn btn-sm themecolor checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                </div>
            </form>
                        ...
                        <table class="table table-bordered topictable" id="headerTable">
                            ...
                            foreach ($lessons as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <?php //if ($this->rbac->hasPrivilege('manage_syllabus_status', 'can_edit')) { 
                                        //echo "<pre>"; print_r($value['topic']); echo "</pre>";
                                     ?>
