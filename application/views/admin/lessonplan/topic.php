<div class="content-wrapper"> 
    ...
    <section class="content">
        <div class="row">
        <?php $this->load->view('_lessonplan_sidemenu'); ?>    
            <?php
                    ...
                    <div class="box box-primary">
                        ...
                        <form   id="topic_form" name="lesson_form" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="btn btn-xs btn-info pull-right themecolor" onclick="add_topic()"><?php echo $this->lang->line('add') . " " . $this->lang->line('more'); ?></label>
                        ...
                        <div class="table-responsive mailbox-messages" id="transfee">
                            ...
                            <table class="table table-hover table-striped" id="headerTable">
                                ...
                                <tr>
                                    ...
                                    <th class="pull-right" style="float:right !important"><?php echo $this->lang->line('action'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                    <?php
...
<script>
    ...
    $(document).on('change', '#subid', function () {
        ...
        $.ajax({
            ...
            data: {'admin_id': admin_id, 'subjectid': sub_id, 'class_id': class_id, 'section_id': section_id, 'subject_group_id': subject_group_id},
            dataType: "json",
            beforeSend: function () {
    ...
    function add_topic() {
        ...
        var id = makeid(8);
        $('#topic_result').append('<div class="form-group" id="' + id + '"><label><?php echo $this->lang->line("topic") . " " . $this->lang->line('name'); ?></label><small class="req"> *</small><input type="text" name="topic[]" class="lessinput" /><span  onclick="remove_topic(' + id + ')" class="section_id_error text-danger">&nbsp;<i style="font-size:18px;padding-left:8px" class="fa fa-remove"></i></span></div>');
    }
