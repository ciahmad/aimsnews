    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Assign Vechicle On Route</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Assign Vechicle On Route</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px"><?= $this->lang->line('route'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('vehicle'); ?></th>                                                
                                        ...
                                        <tbody class="fw-bold">
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="mailbox-name"> <?php echo $vehroute->route_title ?></td>
                                                        ...
                                                        if (!empty($vehicles)) {
                                                            foreach ($vehicles as $key => $value) {
                                                                ...
                                                                echo "<div class='mt-3 mb-3'><b>" . $value->vehicle_no . "</b></div>";
                                                            }
                                                        }
                                                        ?>      
                                                    </td>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Assign Vechicle On Route</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-12 fv-row">
                                        <div class="form-group">
                                            <label for="pwd"><?php echo $this->lang->line('route'); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-15 fv-row mt-7">
                                        <label for="floatingPassword" class="pb-4"><b><?= $this->lang->line('vehicle');  ?></b></label>
                                        <!--begin::Wrapper-->
                                        <?php
                                    foreach ($vehiclelist as $vehicle) {
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <label class="form-check form-check-custom form-check-solid me-10">
                                                <input class="form-check-input h-20px w-20px" type="checkbox" name="vehicle[]" value="<?php echo $vehicle['id'] ?>" />
                                                <span class="form-check-label fw-bold"><?php echo $vehicle['vehicle_no'] ?></span>
                                            </label>
                                            <!--end::Checkbox-->
                                            <!--begin::Checkbox-->
                                            <!--end::Checkbox-->
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/vehroute/create") ?>',
            type: 'POST',
