                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-3">
                                        ...
                                        <?php if($income_result['staff_type']=='student'){?>    
                                            ...
                                            <div class="form-group"> 
                                                <select autofocus="" id="class_id" name="class_id" class="form-control">
                                                    ...
                                                    <?php foreach ($classlist as $class) { ?>
                                                        ...
                                                        if (set_value('class_id', $income_result['class_id']) == $class['id']) { echo "selected = selected"; }
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <div id="name_div">
                                            <input id="name" name="name" placeholder="<?php echo $this->lang->line('enter'); ?> <?php echo $this->lang->line('name'); ?> *" type="text" class="form-control"  value="<?php echo set_value('name', $income_result['name']); ?>" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <select id="cash_bank" name="cash_bank" class="form-control" >
                                            ...
                                            <?php if($income_result['cash_bank']==31){?>
                                        ...
                                        <div class="form-group col-sm-3" >
                                            <select onchange="getBankAccId()" id="deposit_cash_id" name="deposit_cash_id" class="form-control" >
                                                ...
                                                foreach ($deposit_cash_accounts as $deposit_cash_account) {
                                                    ...
                                                    if (set_value('bank_account_id', $income_result['bank_account_id']) == $deposit_cash_account['id']) {
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" class="form-control" id="description" name="description" placeholder="Enter Description" value="<?php echo set_value('description', $income_result['note']) ?>">
...
$(document).on('change', '#class_id', function (e) {
    $('#section_id').html("");
    var section_id      = '<?php echo $income_result['section_id'];?>';
...
$(document).on('change', '#section_id', function (e) {
    var staff_std_id      = '<?php echo $income_result['staff_std_id'];?>';
    $('#name_div').hide();
    $('#staff_std_id').html("");
