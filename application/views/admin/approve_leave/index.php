    ...
    <section class="content">
        <div class="box box-primary">                   
            <div class="box-header with-border themecolor">
                <h3 class="box-title"><i class="fa fa-search"></i>Approve Leave <?php //echo $this->lang->line(''); ?></h3>
            </div>
            <form  class="assign_teacher_form" action="<?php echo base_url(); ?>admin/approve_leave" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <button type="submit" id="search_filter" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right themecolor"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                </div>
            </form>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-header with-border aimsreportsbg">
                        ...
                        <div class="box-tools pull-right">
                            <button type="button" onclick="add_leave()" class="btn btn-sm btn-primary themecolor" data-toggle="tooltip" data-placement="left" ><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button>
                        </div>
                    ...
                    <div class="download_label">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                  ...
                                  <?php echo $this->lang->line('approve') . " " . $this->lang->line('leave') . " " . $this->lang->line('list'); ?> 
                                    </div>
                                </div>
                            </div>
...
?>
                ...
                <div class="box-footer">
                    ...
                    <div class="pull-right paddA10">
                        <button class="btn btn-info pull-right themecolor"  data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait" value=""><?php echo $this->lang->line('save'); ?></button>
