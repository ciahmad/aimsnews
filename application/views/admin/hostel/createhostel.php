    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?= $this->lang->line('hostel') ?></h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Hostel</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px"><?= $this->lang->line('hostel_name'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('type'); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Hostel</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-contain col-sm-4 fv-row">
                                            <label for="floatingPassword" class="required"><?php echo $this->lang->line('hostel_name'); ?></label>
                                            <input type="text" id="hostel_name" name="hostel_name" autocomplete="off" value="" placeholder="<?= $this->lang->line('hostel_name');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                        </div>

                                        <div class="col-sm-4 col-md-4">
                                            <div class="form-group">
                                                <label for="floatingPassword" class="required"><?php echo $this->lang->line('type'); ?></label>
                                                <select id="type" name="type" class="form-control form-control-lg form-control-solid">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-6 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('intake');  ?></label>
                                        <input type="text" id="intake" name="intake" autocomplete="off" value="" placeholder="<?= $this->lang->line('intake');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/hostel/create") ?>',
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    $('#hostel_name, #type, #address, #intake, #description').val("");
