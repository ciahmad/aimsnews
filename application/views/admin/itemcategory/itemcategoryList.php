    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?= $this->lang->line('item_category') ?></h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Item Category</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Item Category</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        ...
                                        <input type="text" id="itemcategory" name="itemcategory" autocomplete="off" value="" placeholder="<?= $this->lang->line('item_category');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-8 fv-row">
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/itemcategory/create") ?>',
            type: 'POST',
