                            ...
                            <form action="<?php echo site_url('admin/syllabus/getteachertimetable'); ?>" id="getTimetable" class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn smallbtn28 themecolor" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait"><?php echo $this->lang->line('search') ?></button>
                                    </div>
                                </div>
                            </form>
                        <?php } ?>
