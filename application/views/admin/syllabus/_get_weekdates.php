                        ...
                        <td class="text text-center" width="14%">
                            ...
                            <?php if (!$timetable[$tm_key]) { ?>
                                ...
                                foreach ($timetable[$tm_key] as $tm_k => $tm_kue) {
                                    ...
                                    $subject_group_subject_class_section = $this->lessonplan_model->getsubject_group_class_sectionsId($tm_kue->class_id, $tm_kue->section_id, $tm_kue->subject_group_id, $admin_id);

                                    $subject_syllabus = $this->syllabus_model->get_subject_syllabusdata($tm_kue->subject_group_subject_id, date('Y-m-d', strtotime($new_date)), $role->id, $staff_id, $tm_kue->time_from, $tm_kue->time_to, $subject_group_subject_class_section['id'], $admin_id);
