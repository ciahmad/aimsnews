                            ...
                            <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <!--end::Menu toggle-->
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6244767fc23b5">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                            ...
                                            <div class="px-7 py-5">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div>
                                                        <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6244767fc23b5" data-allow-clear="true">
                                                            <option></option>
                                        ...
                                        <div class="card card-xl-stretch">
                                            ...
                                            <div class="card-header align-items-center border-0 mt-4">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <!--begin::Menu 1-->
                                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6244767fc38a6">
                                                        <!--begin::Header-->
                                                        <div class="px-7 py-5">
                                                            <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                                        </div>
                                                        ...
                                                        <div class="px-7 py-5">
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <!--begin::Input-->
                                                                <div>
                                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6244767fc38a6" data-allow-clear="true">
                                                                        <option></option>
                                                                        <option value="1">Approved</option>
                                                                        <option value="2">Pending</option>
                                                                        <option value="2">In Process</option>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-45px me-5">
                                                                            <img src="<?php echo base_url(); ?>assets/media/avatars/300-5.jpg" alt="" />
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-45px me-5">
                                                                            <img src="<?php echo base_url(); ?>assets/media/avatars/300-20.jpg" alt="" />
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-45px me-5">
                                                                            <img src="<?php echo base_url(); ?>assets/media/avatars/300-23.jpg" alt="" />
                                                                        </div>
                                                                        <div class="d-flex justify-content-start flex-column">
                                        ...
                                        <div class="card card-xl-stretch mb-xl-8">
                                            ...
                                            <div class="card-body pt-2">
                                                ...
                                                <div class="d-flex align-items-center mb-7">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-50px me-5">
                                                        <img src="<?php echo base_url(); ?>assets/media/avatars/300-5.jpg" class="" alt="" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Text-->
                                                    <div class="flex-grow-1">
                                        ...
                                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                                            ...
                                            <div class="card-body pt-5">
                                                ...
                                                <div class="d-flex align-items-sm-center mb-7">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label">
                                                            <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Section-->
                                                ...
                                                <div class="d-flex align-items-sm-center mb-7">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label">
                                                            <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/telegram.svg" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Section-->
                                                ...
                                                <div class="d-flex align-items-sm-center mb-7">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label">
                                                            <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Section-->
                                                ...
                                                <div class="d-flex align-items-sm-center mb-7">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label">
                                                            <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Section-->
                                                ...
                                                <div class="d-flex align-items-sm-center mb-7">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <span class="symbol-label">
                                                            <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Section-->
                                                ...
                                                <div class="mt-5">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div class="symbol symbol-50px me-3">
                                                                <div class="symbol-label bg-light">
                                                                    <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/plurk.svg" class="h-50" alt="" />
                                                                </div>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                    ...
                                                    <div class="d-flex flex-stack mb-5">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div class="symbol symbol-50px me-3">
                                                                <div class="symbol-label bg-light">
                                                                    <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/figma-1.svg" class="h-50" alt="" />
                                                                </div>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div class="symbol symbol-50px me-3">
                                                                <div class="symbol-label bg-light">
                                                                    <img src="<?php echo base_url(); ?>assets/media/svg/brand-logos/vimeo.svg" class="h-50" alt="" />
                                                                </div>
                                                            </div>
                                                            <!--end::Symbol-->
                                                            <!--begin::Title-->
