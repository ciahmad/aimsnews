    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?= $this->lang->line('vehicle') ?></h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Vehicle</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-lg-5">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        <!--begin::Sidebar-->
                        <?php $this->load->view('_transport_sidemenu'); ?>
                        <!--end::Sidebar-->
                        <!--begin::Content-->
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px"><?= $this->lang->line('vehicle_no'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('vehicle_model'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('year_made'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('driver_name'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('driver_license'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('driver_contact'); ?></th>
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('vehicle_no');  ?></label>
                                        <input type="text" id="vehicle_no" name="vehicle_no" autocomplete="off" value="" placeholder="<?= $this->lang->line('vehicle_no');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('vehicle_model');  ?></label>
                                        <input type="text" id="vehicle_model" name="vehicle_model" autocomplete="off" value="" placeholder="<?= $this->lang->line('vehicle_model');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>

                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('year_made');  ?></label>
                                        <input type="text" id="manufacture_year" name="manufacture_year" autocomplete="off" value="" placeholder="<?= $this->lang->line('year_made');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('driver_name');  ?></label>
                                        <input type="text" id="driver_name" name="driver_name" autocomplete="off" value="" placeholder="<?= $this->lang->line('driver_name');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('driver_contact');  ?></label>
                                        <input type="text" id="driver_contact" name="driver_contact" autocomplete="off" value="" placeholder="<?= $this->lang->line('driver_contact');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>

                                    <div class="input-contain col-sm-4 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('driver_license');  ?></label>
                                        <input type="text" id="driver_licence" name="driver_licence" autocomplete="off" value="" placeholder="<?= $this->lang->line('driver_license');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/vehicle/create") ?>',
            type: 'POST',
