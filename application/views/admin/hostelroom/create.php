    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1"><?= $this->lang->line('hostel_management') ?></h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_reference">Add Hostel Room</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body p-lg-5">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                        <!--begin::Sidebar-->
                        <?php $this->load->view('_hostel_sidemenu'); ?>
                        <!--end::Sidebar-->
                        <!--begin::Content-->
                                    ...
                                    <table style="font-size:12px !important" class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example_1">
                                        <thead>
                                            <tr class="text-start fw-bolder fs-7 text-uppercase themecolor">
                                                <th class="min-w-100px">Room Number/ Name</th>
                                                <th class="min-w-100px"><?= $this->lang->line('hostel'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('room_type'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('numb_of_beds'); ?></th>
                                                <th class="min-w-100px"><?= $this->lang->line('cost_per_bed'); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="data-kt-users-modal-action" style="padding: 10px;background:var(--bs-active-warning) ">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Add Hostel Room</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-contain col-sm-4 fv-row">
                                            <label for="floatingPassword" class="required"><?php echo $this->lang->line('room_no_name'); ?></label>
                                            <input type="text" id="room_no" name="room_no" autocomplete="off" value="" placeholder="<?= $this->lang->line('room_no_name');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                        </div>

                                        <div class="col-sm-4 col-md-4">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('hostel'); ?></label>
                                                <select id="hostel_id" name="hostel_id" class="form-control form-control-lg form-control-solid">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="room_type_id" name="room_type_id" class="form-control form-control-lg form-control-solid">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-6 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('no_of_bed');  ?></label>
                                        <input type="text" id="no_of_bed" name="no_of_bed" autocomplete="off" value="" placeholder="<?= $this->lang->line('no_of_bed');  ?> " class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <div class="input-contain col-sm-6 fv-row">
                                        <label for="floatingPassword"><?= $this->lang->line('cost_per_bed');  ?></label>
                                        <input type="text" id="cost_per_bed" name="cost_per_bed" autocomplete="off" value="" placeholder="<?= $this->lang->line('cost_per_bed');  ?>" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-contain col-sm-12 fv-row">
                                        ...
                                        <input type="text" id="description" name="description" autocomplete="off" value="" placeholder="<?= $this->lang->line('description');  ?>" aria-labelledby="placeholder-name" class="form-control form-control-lg form-control-solid" spellcheck="false" data-ms-editor="true">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
...
<script>
    $(".add_reference_data").on('click', function(e) {
        ...
        $this.button('loading');
        $.ajax({
            url: '<?php echo site_url("admin/hostelroom/create") ?>',
            type: 'POST',
            ...
            success: function(data) {
                ...
                if (data.status == "fail") {
                    ...
                    $('#room_no, #hostel_id, #room_type_id, #no_of_bed, #cost_per_bed, #description').val("");
