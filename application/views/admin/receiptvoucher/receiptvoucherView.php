...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-usd"></i> <?php echo $this->lang->line('receipt_voucher').' '.$this->lang->line('view'); ?></h1>
    </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><?php echo $this->lang->line('receipt_voucher').' '.$this->lang->line('view'); ?></h3>
                        </div><!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('cash_bank'); ?></label>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <?php if($rvresult['cash_bank']==31){?>
                                            <?php echo $this->lang->line('bank'); ?>
                                        <?php } if($rvresult['cash_bank']==30){?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-7"></div>
                                        <div class="form-group col-md-1">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('deposit_cash'); ?></label>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <?php 
                                            $data['bankAccount']   = $this->account_model->get($rvresult['rv_account_id']);
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-7"></div>
                                        <div class="form-group col-md-1">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('bank_acc'); ?></label>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <?php 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-7"></div>
                                        <div class="form-group col-md-1">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('ref_no'); ?></label>
                                        </div>
                                        <div class="form-group col-md-4" >
