...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-usd"></i> <?php echo $this->lang->line('edit').' '.$this->lang->line('receipt_voucher'); ?></h1>
    </section>
                ...
                <div class="col-md-10">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><?php echo $this->lang->line('update').' '.$this->lang->line('receipt_voucher'); ?></h3>
                        </div><!-- /.box-header -->
                        <form action="<?php echo base_url("admin/receiptvoucher/edit/". $id) ?>"  id="rvform" name="rvform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <?php if($rvresult['staff_type']=='student'){?>    
                                            ...
                                            <div class="form-group"> 
                                                <select autofocus="" id="class_id" name="class_id" class="form-control">
                                                    ...
                                                    <?php foreach ($classlist as $class) { ?>
                                                        ...
                                                        if (set_value('class_id', $rvresult['class_id']) == $class['id']) { echo "selected = selected"; }
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div id="name_div">
                                            <input id="name" name="name" placeholder="Enter Name" type="text" class="form-control"  value="<?php echo set_value('name', $rvresult['name']); ?>" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        <input id="invoice_no" name="invoice_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('invoice_no', $rvresult['invoice_no']); ?>" readonly style="background-color: #dddddd94;"/>
                                    ...
                                    <div class="form-group col-md-4">
                                        <select id="deposit_cash_id" name="deposit_cash_id" class="form-control" >
                                            ...
                                            foreach ($deposit_cash_accounts as $deposit_cash_account) {
                                                ...
                                                if (set_value('deposit_cash_id', $rvresult['bank_account_id']) == $deposit_cash_account['id']) {
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select autofocus="" id="bank_account_id" name="bank_account_id" class="form-control" onchange="getBankAccId()">
                                            ...
                                            foreach ($bankAccounts as $bankAccount) {
                                                ...
                                                if (set_value('bank_account_id', $rvresult['bank_account_id']) == $bankAccount['id']) {
                                                    echo "selected = selected";
                                                }
                                ...
                                <div class="col-md-12" style="display: none;" id="reference_number_div">
                                    ...
                                    <div class="form-group col-md-4" >
                                        <input id="reference_number" name="reference_number" placeholder="" type="text" class="form-control"  value="<?php echo set_value('reference_number', $rvresult['reference_number']); ?>" />
                                                ...
                                                <table class="table table-hover table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input id="total_amount" name="total_amount" type="text" class="form-control" value="<?php echo set_value('name', $rvresult['total_amount']); ?>" style="text-align: right; font-size: 16px; font-weight: 600;"/>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <div class="box-footer">
                                    <button type="submit" id="submitrv" class="btn btn-info pull-right themecolor"><?php echo $this->lang->line('update'); ?></button>
                                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped example">
                                ...
                                <tbody>
                                    <?php
                                    if (empty($rvoucherlist)) {
                                        ?>

                                        <?php
                                    } else {
                                        $balance = 0;
                                        foreach ($rvoucherlist as $list) {
...
$(document).ready(function () {
        ...
        staff_type      = '<?php echo $rvresult['staff_type'];?>';
        staff_std_id    = '<?php echo $rvresult['staff_std_id'];?>';
...
function checkTypeEdit(staff_type, staff_std_id){
    ...
    if(staff_type=='staff' && $("#staff").prop('checked')==true){
        ...
        $('#staff_div').hide();
        $('#class_section_div').hide();
        $('#name').val('<?php echo $rvresult['name']; ?>');
    }  
    //alert(staff_type);
...
$(document).on('change', '#class_id', function (e) {
    $('#section_id').html("");
    var section_id      = '<?php echo $rvresult['section_id'];?>';
...
$(document).on('change', '#section_id', function (e) {
    var staff_std_id      = '<?php echo $rvresult['staff_std_id'];?>';
    $('#name_div').hide();
    $('#staff_std_id').html("");
