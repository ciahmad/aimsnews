...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-usd"></i><?php echo $this->lang->line('journal_voucher'). ' ' .$this->lang->line('edit'); ?></h1>
    </section>
                ...
                <div class="col-md-10">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border themecolor">
                            <h3 class="box-title"><?php echo $this->lang->line('journal_voucher'). ' ' .$this->lang->line('edit'); ?></h3>
                        </div><!-- /.box-header -->

                        <form action="<?php echo base_url("admin/journalvoucher/edit/". $id) ?>"  id="editrvform" name="editrvform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <?php if($jvresult['staff_type']=='student'){?>    
                                        <input onchange="checkType('student',0)" type="checkbox" name="staff_type" value="student" id="student" checked >&nbsp;&nbsp;
                                        <?php }else{?>
                                            <input onchange="checkType('student',0)" type="checkbox" name="staff_type" value="student" id="student" >&nbsp;&nbsp;
                                        <?php }?>
                                        <label for="staff"><?php echo $this->lang->line('staff'); ?></label>&nbsp;&nbsp;
                                        <?php if($jvresult['staff_type']=='staff'){?> 
                                            <input onchange="checkType('staff',0)" type="checkbox" name="staff_type" value="staff" id="staff" checked>
                                        <?php }else{?>
                                            <input onchange="checkType('staff',0)" type="checkbox" name="staff_type" value="staff" id="staff">
                                        <?php }?>&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="form-group"> 
                                                <select autofocus="" id="class_id" name="class_id" class="form-control">
                                                    ...
                                                    <?php foreach ($classlist as $class) { ?>
                                                        ...
                                                        if (set_value('class_id', $jvresult['class_id']) == $class['id']) { echo "selected = selected"; }
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div id="name_div">
                                            <input id="name" name="name" placeholder="Enter Name" type="text" class="form-control" value="<?php echo $jvresult['name']; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        <input id="date" name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($jvresult['date']))); ?>" readonly="readonly" />
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-sm-6"></div>
                                    <div class="col-md-2 col-sm-2">
                                        <label for="jv_number"><?php echo $this->lang->line('jv_number'); ?></label>
                                    </div></label>
                                    <div class="form-group col-md-4">
                                        <input id="invoice_no" name="invoice_no" placeholder="" type="text" class="form-control"  value="<?php echo $jvresult['invoice_no']; ?>"  style="background-color: #dddddd94;" readonly/>
                                    ...
                                    <table class="table table-hover table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="debit_total" name="debit_total" type="text" class="form-control" value="<?php echo $jvresult['debit_total']; ?>" style="text-align: right; font-size: 16px; font-weight: 600;width: 120px;"/></td>
                                                <td><input id="credit_total" name="credit_total" type="text" class="form-control" value="<?php echo $jvresult['credit_total']; ?>" style="text-align: right;font-size: 16px; font-weight: 600; width: 120px;"/></td>
                                            </tr>
                                            <tr >
                                                
                                                <td colspan="4">
                                                    <button style="float: right;" type="button" class="colorbtn" id="add_more" data-id="<?php echo $count;?>" onclick="addMore()">Add More</button>
                                                </td>
                                            </tr>
                                ...
                                <div class="box-footer text-right">
                                    <button type="submit" class="btn btn-info pull-right colorbtn"><?php echo $this->lang->line('save_close'); ?></button>
                                    <!-- <button type="submit" class="btn btn-info pull-left colorbtn" style="margin-left: 5px;"><?php echo $this->lang->line('save_print'); ?></button>
                                    <button type="submit" class="btn btn-info pull-left colorbtn" style="margin-left: 5px;"><?php echo $this->lang->line('save_new'); ?></button> -->
                                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped table-bordered example">
                                ...
                                <tbody>
                                    <?php
                                    if (empty($jvoucherlist)) {
                                        ?>

                                        <?php
                                    } else {
                                        foreach ($jvoucherlist as $list) {
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        staff_type      = '<?php echo $jvresult['staff_type'];?>';
        staff_std_id    = '<?php echo $jvresult['staff_std_id'];?>';
        checkType(staff_type, staff_std_id);
    });

    function checkType(staff_type, staff_std_id){
    ...
    if(staff_type=='staff' && $("#staff").prop('checked')==true){
        ...
        $('#staff_div').hide();
        $('#class_section_div').hide();
        $('#name').val('<?php echo $jvresult['name']; ?>');
    } 
    //alert(staff_type);
...
$(document).on('change', '#class_id', function (e) {
    $('#section_id').html("");
    var section_id      = '<?php echo $jvresult['section_id'];?>';
...
$(document).on('change', '#section_id', function (e) {
    var staff_std_id      = '<?php echo $jvresult['staff_std_id'];?>';
    $('#name_div').hide();
    $('#staff_std_id').html("");
