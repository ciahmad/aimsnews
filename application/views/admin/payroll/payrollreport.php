...
<?php } ?>   
                                        ...
                                        <div class="col-sm-12"> 
                                            <div class="form-group">
                                            <button type="submit" name="search" value="search_filter" class="btn btn-sm themecolor checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                        </div>
                                    </div>
                                  </div>  
                                 </div>  
                        ...
                        <div class="box-body table-responsive">     
                            <div class="tab-content">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    ...
                                    <?php echo $this->lang->line('payroll'); ?> <?php echo $this->lang->line('report_for')."<br>"; $this->customlib->get_postmessage(); ?>
                                    </div>
                                </div>
                            </div>
                                    <!-- <div class="download_label">
