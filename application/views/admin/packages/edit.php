        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/packages/edit/' . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name', $editpackage['name']); ?>" />
                                            ...
                                            <!-- <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="description" name="description" placeholder="" type="text" class="form-control"  value="<?php echo set_value('description',$editpackage['description']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="number_of_location"  name="number_of_location" placeholder="" type="text" class="form-control"  value="<?php echo set_value('number_of_location',$editpackage['number_of_location']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="number_of_users"><?php echo $this->lang->line('number_of_users'); ?></label><small class="req"> *</small>
                                                    <input id="number_of_users" name="number_of_users" placeholder="" type="text" class="form-control"  value="<?php echo set_value('number_of_users',$editpackage['number_of_users']) ?>" />
                                                    <span class="text-danger"><?php echo form_error('number_of_users'); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="number_of_files" name="number_of_files" placeholder="" type="text" class="form-control"  value="<?php echo set_value('email',$editpackage['number_of_files']) ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="number_of_cases" name="number_of_cases" placeholder="" type="text" class="form-control"  value="<?php echo set_value('number_of_cases',$editpackage['number_of_cases']) ?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="price_interval">
                                                    ...
                                                    foreach ($intervals as $key => $value) {
                                                        if ($editpackage['price_interval'] == $key) {
                                                           $selected = 'selected';
                                                        }else{
                                                            $selected = '';
                                                        }
                                                        ?>
                                                        <option value="<?php echo $key; ?>" <?php echo set_select('price_interval', $key, set_value('price_interval')); ?> <?php echo $selected;?> ><?php echo $value; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="interval_count" name="interval_count" placeholder="" type="text" class="form-control"  value="<?php echo set_value('interval_count',$editpackage['interval_count']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="trial_days" name="trial_days" placeholder="" type="text" class="form-control"  value="<?php echo set_value('trial_days',$editpackage['trial_days']) ?>" />
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="price" name="price" placeholder="" type="text" class="form-control"  value="<?php echo set_value('price',$editpackage['price']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="sort_order" name="sort_order" placeholder="" type="text" class="form-control"  value="<?php echo set_value('sort_order',$editpackage['sort_order']) ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <?php if($editpackage['is_active']==1){?>
                                                    <input type="checkbox" name="is_active" value="1"  autocomplete="off" checked > 
                                                    <?php }else{?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('pack_description'); ?></label>
                                                    <textarea name="description" id="compose-textarea" class="form-control" ><?php echo set_value('description', $editpackage['description']); ?></textarea>
                                                    <span class="text-danger"><?php echo form_error('description'); ?></span>
                                                </div>
                                            </div>
