            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="box-title"><i class="fa fa-search"></i>Fee Discount <?php //echo $this->lang->line('select_criteria'); ?></h3>
                            </div>
                            <div class="col-md-6 text-right"><a style="float: right; color: #fff" href="<?php echo base_url('admin/feediscount')?>"><i class="fa fa-backward"></i>Back</a></div>
                        </div>                        
                    </div>
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('admin/feediscount/assign/' . $id) ?>" method="post" class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary pull-right btn-sm themecolor checkbox-toggle"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                </div>
                            </div>
                        </form>
