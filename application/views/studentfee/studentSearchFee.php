            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border themecolor">
                        <h3 class="box-title"><i class="fa fa-search"></i>Search Due Fee <?php //echo $this->lang->line(''); ?></h3>
                    </div>
                    <form action="<?php echo site_url('studentfee/feesearch') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                                ...
                                                <optgroup label="<?php echo $feecategory->group_name; ?>">
                                                    ...
                                                    if (!empty($feecategory->feetypes)) {
                                                        foreach ($feecategory->feetypes as $fee_key => $fee_value) {
                                                            ...
                                                            ?>  value="<?php echo $feecategory->id . "-" . $fee_value->id; ?>"><?php echo $fee_value->type; ?>(<?php echo $fee_value->code; ?>)</option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-primary pull-right themecolor"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="" id="duefee">
                            ...
                            <div class="box-body table-responsive">
                                ...
                                <div class="row" style="padding-top:0px; margin-top:0px">
                                    ...
                                    <?php //echo $this->lang->line(''); ?> Due Fee List
                                    </div>
                                </div>
                            </div>
                                            ...
                                            echo (number_format(($student['amount'] - ($student['amount_detail'] + $student['amount_discount'])), 2, '.', ''));
                                                ?></td>
                                                    <td class="text text-right">
                                                        <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_add')) { ?><a href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student['student_session_id'] ?>" class="btn btn-info btn-xs themecolor">
