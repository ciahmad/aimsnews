                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="btn-group pull-right">
                                    <a href="<?php echo $referer_url; ?>" type="button" class="btn btn-primary btn-xs">
                                ...
                                <div class="sfborder">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        if (isset($_REQUEST['size']))
                                            ...
                                            echo '<img src="http://aims.1pixelcoding.com/'.$PNG_WEB_DIR.basename($filename).'" />'; 
                                        ?>
                                    </div>
                                        ...
                                        foreach ($fee->fees as $fee_key => $fee_value) {
                                            ...
                                            if (!empty($fee_value->amount_detail)) {
                                                ...
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    //echo "<pre>".print_r($fee_deposits_value);
                                                    $is_deleted = $fee_deposits_value->is_deleted;
                                                    if($fee_deposits_value->is_deleted=='No'){
                                                ...
                                                //echo '<pre>'.print_r($fee_value->amount_detail->amount);
                                            }
                                            ...
                                            if ($feetype_balance > 0 && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                ...
                                                <td align="left" class="text text-left width85">
                                                    <?php
                                                    if ($feetype_balance == 0 && $is_deleted =='No') {
                                                        ?><span class="label label-success"><?php echo $this->lang->line('paid'); ?></span><?php
                                                    } else if (!empty($fee_value->amount_detail) && $is_deleted =='No') {
                                                ...
                                                <td>
                                                    <div class="btn-group pull-right">
                                                        <button type="button" data-student_session_id="<?php echo $fee->student_session_id; ?>" data-student_fees_master_id="<?php echo $fee->id; ?>" data-fee_groups_feetype_id="<?php echo $fee_value->fee_groups_feetype_id; ?>" data-fee_acc_id="<?php echo $fee_value->code; ?>"
                                                                ...
                                                                data-fee_group_title="<?php echo $fee_value->name . " (" . $fee_value->type . ")";?>"
                            ...
                            <table class="table table-hover table-striped table-bordered" id="example_table" >
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right">
                                                <input type="text" name="total_amount" id="total_amount" value="" style="text-align:right;"> 
                                            </td>
                                        </tr>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th id="total_pay" style="text-align:right;background-color:#dddddd94">
                                        </th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td>
                                        <label class="col-sm-1" for="exampleInputEmail1">Fine: </label>
                                        <div class="col-sm-7" >
                                    ...
                                    <td style="text-align:right;">
                                        <input style="text-align:right;" type="text" name="fine_amount" id="fine_amount" readonly value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label class="col-sm-1" for="exampleInputEmail1">Discount: </label>
                                        <?php //print_r($discount_not_applied);?>
                                        <div class="col-sm-7" >
                                           <select autofocus="" id="sel_discount" name="sel_discount" class="form-control">
                                            <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            <?php foreach ($discount_not_applied as $key => $value) { ?>
                                    ...
                                    <td style="text-align:right;">
                                        <input style="text-align:right;" type="text" name="discount_amount" id="discount_amount" readonly value="0">
                                    </td>
                                </tr>
                                <thead>
                                    <tr>
                                        <th style="text-align: right;background-color:#dddddd94">Net Total:</th>
                                        <th style="text-align:right;background-color:#dddddd94"><span id="net_total"></span></th>
...
<script type="text/javascript">
    $(document).on('click', '.save_button', function (e) {
        ...
        if($('#cash_bank').val()==104){
            ...
            var bank_account_id   = $('#cash_bank').val();
            var mode_id = 0;
