        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <div class="box-header aimsreportsbg">
                        <h3 class="box-title"><i class="fa fa-search"></i>Fee Collection Report <?php //echo $this->lang->line('select_criteria'); ?></h3>
                    </div>
                    ...
                    <div class="">
                        ...
                        <div class="download_label ">
                            ...
                            <!-- <div class="download_label">
                                <?php ?> <?php //echo $this->lang->line('fees') . " " . $this->lang->line('collection') . " " . $this->lang->line('report') . "<br>";
                            ...
                            <div class="row" style="padding-top:0px; margin-top:0px">
                                ...
                                <?php
                                  echo $this->lang->line('fees') . " " . $this->lang->line('collection') . " " . $this->lang->line('report') . "<br>";
                                   $this->customlib->get_postmessage();
                                 ?>
                            </div>
                            </div>
